...
import { deleteSampleTemplate, querySampleTemplate, saveSampleTemplate } from '@/api'
...
const fetchData = async () => {
  const { code, data } = await querySampleTemplate({
...
const deleteSampleTemplateFun = async (record: any) => {
  const { code, data } = await deleteSampleTemplate({
...
const saveSampleVisualFun = async () => {
  ...
  const { code, data } = await saveSampleTemplate({
    ...formState.value,
    measureType: props.measureType,
