  ...
  <section class="uv-container !h-full">
    <div class="uv-table-page">
      <div class="flex items-center justify-between !mb-3">
        <div class="text-[18px] !font-bold" :style="{ color: primaryColor }">任务列表</div>
        <div class="flex">
...
import { deleteTask, getTasksManagementList, methodExport } from '@/api'
const { primaryColor } = useAppStore()
import { useDownloadFile } from '@/composables/useDownloadFile'
import createTask from '@/views/experiment/experimentTest/components/createTask.vue'
...
const deleteTaskFun = async (ids: any) => {
  const { data, code } = await deleteTask({
    params: ids,
  })
  if (code === 200) {
