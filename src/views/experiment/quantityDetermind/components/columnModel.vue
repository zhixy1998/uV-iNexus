...
<template>
  <uvModal v-model="model" title="列配置" @handleOk="saveInputParamMapTableHeadFun">
    <template #content>
...
import { queryInputParam, queryInputParamMapTableHead, saveInputParamMapTableHead } from '@/api'
