  ...
  var t = {
      ...
      388: function (t, e, r) {
        ...
        !(function (t) {
          ...
          function p() {
            ;(u = new e.MathJax._.core.MmlTree.SerializedMmlVisitor.SerializedMmlVisitor()),
          ...
          try {
            for (var a = r(l(t)), d = a.next(); !d.done; d = a.next()) {
              var p = d.value,
                ...
                y = h.value
              Array.isArray(y) ? (h.value = f([], y, !1)) : i(y) && (h.value = s(y)),
                h.enumerable && (o[p] = h)
            }
          } catch (t) {
            e = { error: t }
          ...
          (e.separateOptions = function (t) {
            ...
            try {
              for (var l = r(i), s = l.next(); !s.done; s = l.next()) {
                ...
                try {
                  for (
                    var h = ((o = void 0), r(Object.keys(t || {}))), y = h.next();
                    !y.done;
                    y = h.next()
                  ) {
                    var v = y.value
  ...
  ;(r.g = (function () {
    ...
    (function () {
      ...
      MathJax.loader && MathJax.loader.checkVersion('startup', e.VERSION, 'startup'),
        (0, t.combineWithMathJax)({ _: { components: { loader: n, package: o, startup: a } } })
      var u,
        c = {
