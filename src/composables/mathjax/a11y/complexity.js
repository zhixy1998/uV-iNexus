!(function () {
          ...
          return (
            ...
            (e.OPTIONS = n(n(n({}, t.OPTIONS), u.ComplexityVisitor.OPTIONS), {
              ...
              renderActions: (0, h.expandable)(
                n(n({}, t.OPTIONS.renderActions), { complexity: [p.STATE.COMPLEXITY] }),
              ),
            })),
            e
          )
            ...
            ;(this.cutoff = {
              ...
              (this.collapse = new Map([
                    ...
                    if (1 === o.splitAttribute(t, 'children').length) {
                      ...
                      if (i) {
                        ...
                        o.unrecordCollapse(i),
                          (e = o.recordCollapse(t, o.complexity.visitNode(t, !1), r))
                      }
                    }
                    return e
                  },
                ...
                [
                  ...
                  function (t, e) {
                    return (
                      (e = o.uncollapseChild(e, t, 0, 2)) > o.cutoff.superscript &&
                ...
                [
                  ...
                  function (t, e) {
                    return (
                      (e = o.uncollapseChild(e, t, 0, 2)) > o.cutoff.subscript &&
          ...
          return (
            ...
            (t.prototype.canUncollapse = function (t, e, o) {
              if ((void 0 === o && (o = 1), this.splitAttribute(t, 'children').length === o)) {
                var i =
                  1 === t.childNodes.length && t.childNodes[0].isInferred ? t.childNodes[0] : t
                if (i && i.childNodes[e]) {
          ...
          p = (function (t) {
            ...
            return (
              ...
              (e.prototype.visitMfracNode = function (t, e) {
                var o =
                  this.childrenComplexity(t) * this.complexity.script + this.complexity.fraction
                return this.setComplexity(t, o, e)
              }),
              ...
              (e.prototype.visitMsubsupNode = function (e, o) {
                ...
                var i = e.childNodes[e.sub],
                  ...
                  l =
                    Math.max(i ? this.getComplexity(i) : 0, r ? this.getComplexity(r) : 0) *
  ...
  ;(t = a(723)),
    ...
    (0, t.r8)({
      _: {
        a11y: { complexity_ts: o, complexity: { collapse: i, visitor: r }, 'semantic-enrich': n },
      },
    }),
    MathJax.startup &&
