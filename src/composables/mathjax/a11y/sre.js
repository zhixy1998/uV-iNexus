  ...
  var __webpack_modules__ = {
            ...
            for (let n = 0; n < e.length; n++) {
              ...
              o && !i.MARKS[o] && (t.push('<mark name="' + o + '"/>'), (i.MARKS[o] = !0)),
                1 === r.speech.length && r.speech.match(/[a-zA-Z]/)
                  ? t.push(
                      '<say-as interpret-as="' + i.CHARACTER_ATTR + '">' + r.speech + '</say-as>',
                    )
                  : t.push(r.speech)
            }
            ...
            const c = (e) => {
              for (let t, r = 0; (t = e[r]); r++) {
                ...
                if (e && t === parseInt(o.getInnerNode(e).getAttribute(s.Attribute.ID)))
                  o.getInnerNode(e).setAttribute(s.Attribute.PARENT, this.semantic.id.toString()),
                    i++
                else {
      ...
      8672: function (e, t, n) {
        ...
        function S(e, t, n) {
          ...
          for (; o.length; ) {
            ...
            0 !== t.length &&
              (1 !== t.length
                ? (s ? e.setAttribute('AuxiliaryImplicit', !0) : (s = !0), (o = t.concat(o)))
                : r.push(e))
          }
          const a = [],
        ...
        function E(e, t, n) {
          ...
          let r = t,
            i = P(r)
          for (; i && i.firstChild === r && !r.hasAttribute('AuxiliaryImplicit') && i !== e; )
            (r = i), (i = P(r))
        ...
        function p(e) {
          ...
          if (e.match(/^name\(\.\.\/\.\.\)="\w+"$/)) {
            ...
            return (e) => {
              ...
              return (
                (null ===
                  (i = null === (n = e.parentNode) || void 0 === n ? void 0 : n.parentNode) ||
                void 0 === i
                  ? void 0
          ...
          (t.localeFontCombiner = function (e) {
            return 'string' == typeof e
              ...
              : {
                  font: e[0],
                  combiner:
                    r.LOCALE.COMBINERS[e[1]] || i.Combiners[e[1]] || r.LOCALE.ALPHABETS.combiner,
                }
          })
      },
      8597: function (e, t, n) {
      ...
      5571: function (e, t, n) {
        ...
        function i(e, t = !1) {
          ...
          if (((i += o ? r(o, !0) + ' hundrede' : ''), (n %= 100), n))
            if (((i += i ? ' og ' : ''), (o = t ? a.special.smallOrdinals[n] : a.ones[n]), o))
              i += o
            else {
          ...
          for (; e > 0; ) {
            ...
            if (r) {
              ...
              if (e && e.match(/^mille /)) {
                ...
                (e = 1 === r && e ? e.replace(/s$/, '') : e), (n = i + (t ? '-' + e + '-' : '') + n)
            }
            ;(e = Math.floor(e / 1e3)), t++
          }
          return n.replace(/-$/, '')
        ...
        class c extends s.BaseRuleStore {
          ...
          evaluateString(e) {
            ...
            for (let e, r = 0; (e = o[r]); r++)
              ...
              else if (e.match(new RegExp('^[' + i.LOCALE.MESSAGES.regexp.TEXT + ']+$')))
      ...
      6060: function (e, t, n) {
        ...
        class S {
          ...
          getEvaluator(e, t) {
            const n =
              this.evaluators_[e] || this.evaluators_[h.DynamicCstr.DEFAULT_VALUES[h.Axis.LOCALE]]
          ...
          evaluateTree_(e) {
            ...
            for (let t, i = 0; (t = u[i]); i++) {
              ...
              i[0] &&
                !u &&
                (a.context &&
                  (i[0].context = l.constructString(e, a.context) + (i[0].context || '')),
          ...
          evaluateNodeList_(e, t, n, i, o, s) {
            ...
            for (let e, n = 0; (e = t[n]); n++) {
              ...
              if (
                r.length > 0 &&
                ((r[0].context = u() + (r[0].context || '')), (p = p.concat(r)), n < t.length - 1)
              ) {
                const e = h()
                p = p.concat(e)
              }
          ...
          lookupRule(e, t) {
            if (
              !e ||
              (e.nodeType !== o.NodeType.ELEMENT_NODE && e.nodeType !== o.NodeType.TEXT_NODE)
            )
              return null
      ...
      7103: function (e, t, n) {
        ...
        function h(e, t, n) {
          ...
          if (!i)
            return r.Debugger.getInstance().output('Juxta Heuristic Case 3'), h([o].concat(a), t, n)
          const l = a.shift()
          if (!l) {
            r.Debugger.getInstance().output('Juxta Heuristic Case 9')
            const a = s.factory.makeBranchNode('infixop', [i, t.shift()], [o], o.textContent)
            return (
              (a.role = 'implicit'), s.run('combine_juxtaposition', a), t.unshift(a), h(e, t, n)
            )
          }
            ...
            new a.SemanticMultiHeuristic('convert_juxtaposition', (e) => {
              ...
              ;(t = t.rel.length
                ? (function (e) {
                    ...
                    for (; e.comp.length; )
                      if (((o = []), r.length))
                        i && t.push(i), n.push(r), (i = e.rel.shift()), (r = e.comp.shift())
                      else {
        ...
        class l {
          ...
          fractionLikeNode(e, t, n, r) {
            ...
            if (!r && c.isZeroLength(n)) {
              ...
              return (
                (i = l.getInstance().factory_.makeBranchNode('multiline', [n, r], [])),
                l.binomialForm_(i),
          ...
          getLabel(e, t, n, i) {
            const o = l.getInstance().findNestedRow(t, 'prooflabel', i),
              s = l
                .getInstance()
                .factory_.makeBranchNode('rulelabel', n(r.toArray(o.childNodes)), [])
          ...
          fences_(e, t, n, r) {
            ...
            if (o && 'close' === s && a.isNeutralFence(o) && n.some(i)) {
              ...
              return (
                r.push(r.pop().concat([d], t.shift())), l.getInstance().fences_(e, t, o.head, r)
              )
            }
            const u = e.shift()
            return (
          ...
          getFunctionArgs_(e, t, n) {
            ...
            switch (n) {
              case 'integral': {
                ...
                return (
                  (o = l.getInstance().integralNode_(e, r, n.intvar)), n.rest.unshift(o), n.rest
                )
              }
              case 'prefix':
      ...
      3269: function (e, t, n) {
        ...
        function b(e) {
          const t =
            'sqrt' === e.tagName ? '2' : o.evalXPath('children/*[1]', e)[0].textContent.trim()
      ...
      4660: function (e, t, n) {
        ...
        class y {
          ...
          depth() {
            return (
              (this.moved = this.isSpeech() ? b.WalkerMoves.DEPTH : b.WalkerMoves.REPEAT),
              this.getFocus().clone()
            )
          }
          home() {
          ...
          summary() {
            return (
              (this.moved = this.isSpeech() ? b.WalkerMoves.SUMMARY : b.WalkerMoves.REPEAT),
              this.getFocus().clone()
            )
          }
          detail() {
            return (
              (this.moved = this.isSpeech() ? b.WalkerMoves.DETAIL : b.WalkerMoves.REPEAT),
              this.getFocus().clone()
            )
          }
          specialMove() {
          ...
          collapsedChildren_(e) {
            const t = (e) => {
              ...
              for (let r = 1, i = e.length; r < i; r++) {
                const i = e[r]
                n.childNodes.push(
                  c.SemanticSkeleton.simpleCollapseStructure(i) ? this.nodeDict[i] : t(i),
                )
              }
              return n
            }
