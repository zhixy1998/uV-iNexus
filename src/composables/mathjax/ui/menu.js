  ...
  var __webpack_modules__ = {
              ...
              (t.prototype.post = function (t, n) {
                if (this.mathItem) {
                  if (void 0 !== n) {
                    ...
                    ;(o.content = 'MathML' === r ? 'Original MathML' : r + ' Commands'),
              ...
              (t.prototype.findID = function () {
                ...
                try {
                  for (var a = i(n), l = a.next(); !l.done; l = a.next()) {
                    var u = l.value
                    o
                      ? ((s = o.find(u)), (o = s instanceof c.Submenu ? s.submenu : null))
                      : (s = null)
                  }
                } catch (t) {
                  e = { error: t }
            ...
            return (
                  ...
                  items: [
                    ...
                    this.submenu('Settings', 'Math Settings', [
                      ...
                      this.submenu('ZoomTrigger', 'Zoom Trigger', [
                        ...
                        this.checkbox('Command', 'Command', 'cmd', { hidden: !S }),
                        this.checkbox('Control', 'Control', 'ctrl', { hiddne: S }),
              ...
              (e.prototype.setExplorer = function (e) {
                this.enableExplorerItems(e),
                  ...
                  !e || (y._.a11y && y._.a11y.explorer)
                    ? this.rerender(this.settings.collapsible ? a.STATE.RERENDER : a.STATE.COMPILED)
                    : this.loadA11y('explorer')
              }),
              ...
              (e.prototype.loadA11y = function (t) {
                ...
                this.loadComponent('a11y/' + t, function () {
                  ...
                  ;(n.document = o.document = o.getDocument()),
                    ...
                    e._loadingPromise ||
                      (n.document.outputJax.reset(),
                      n.rerender('complexity' === t || r ? a.STATE.COMPILED : a.STATE.TYPESET))
                })
              }),
              ...
              (e.prototype.zoom = function (e, t, n) {
                ;(e && !this.isZoomEvent(e, t)) ||
                  ((this.menu.mathItem = n), e && this.menu.post(e), this.zoomBox.post())
              }),
              ...
              (e.prototype.command = function (e, t, n, r) {
                return (
                  void 0 === r && (r = {}),
                  Object.assign({ type: 'command', id: e, content: t, action: n }, r)
                )
              }),
              (e.prototype.checkbox = function (e, t, n, r) {
                return (
                  void 0 === r && (r = {}),
                  Object.assign({ type: 'checkbox', id: e, content: t, variable: n }, r)
                )
              }),
              ...
              (e.prototype.radio = function (e, t, n, r) {
                return (
                  void 0 === r && (r = {}),
                  Object.assign({ type: 'radio', id: e, content: t, variable: n }, r)
                )
              }),
          ...
          return (
            ...
            (t.prototype.post = function (e, t) {
              this.posted ||
                (void 0 !== e &&
                  void 0 !== t &&
                  this.html.setAttribute('style', 'left: ' + e + 'px; top: ' + t + 'px;'),
                this.display(),
                (this.posted = !0))
            }),
            (t.prototype.unpost = function () {
        ...
        var i = n(3757),
          ...
          a = (function (e) {
            function t(t) {
              ...
              return (
                (n.element = t), (n.className = s.HtmlClasses.MENUCLOSE), (n.role = 'button'), n
              )
            }
            return (
              o(t, e),
            ...
            return (
              ...
              (t.prototype.post = function (t, n) {
                ...
                var r,
                  ...
                  s = t
                if (
                  (s instanceof Event ? ((r = s.target), this.stop(s)) : (r = s),
                  s instanceof MouseEvent &&
                    ...
                    o ||
                      ...
                      !s.clientX ||
                      ((o =
                        s.clientX + document.body.scrollLeft + document.documentElement.scrollLeft),
                      (i =
                        s.clientY + document.body.scrollTop + document.documentElement.scrollTop))),
                  !o && !i && r)
                ) {
              ...
              (t.prototype.move_ = function (e) {
                this.anchor &&
                  e !== this.anchor &&
                  ((this.moving = !0), this.unpost(), this.post(e), (this.moving = !1))
              }),
              t
            )
          })(i.AbstractMenu)
          ...
          a = (function (e) {
            ...
            return (
              ...
              (t.prototype.post = function () {
                ...
                n.setAttribute('style', 'margin-left: ' + o + 'px; top: ' + i + 'px;'),
                  window.event instanceof MouseEvent && n.classList.add(s.HtmlClasses.MOUSEPOST),
                  n.focus()
              }),
              (t.prototype.display = function () {
              ...
              (t.prototype.generateContent = function () {
                ...
                return (
                  e.classList.add(s.HtmlClasses.INFOCONTENT), e.setAttribute('tabindex', '0'), e
                )
              }),
              (t.prototype.generateSignature = function () {
                var e = document.createElement('span')
                return (
                  (e.innerHTML = this.signature), e.classList.add(s.HtmlClasses.INFOSIGNATURE), e
                )
              }),
              (t.prototype.toJson = function () {
                return { type: '' }
          ...
          a = (function () {
            function e(e) {
              ;(this.menu = e),
                ...
                (this._active = null),
                (this.counter = 0),
                (this.attachedClass = i.HtmlClasses.ATTACHED + '_' + o.MenuUtil.counter()),
                (this.taborder = !0),
                (this.attrMap = {})
            }
            return (
              ...
              (e.prototype.previous = function () {
                ...
                return (
                  (n = -1 === n || 0 === n ? t : n - 1), (this.active = this.store[n]), this.active
                )
              }),
              (e.prototype.clear = function () {
              ...
              (e.prototype.addTabindex = function (e) {
                e.hasAttribute('tabindex') &&
                  e.setAttribute(i.HtmlAttrs.OLDTAB, e.getAttribute('tabindex')),
                  e.setAttribute('tabindex', '0')
              }),
              (e.prototype.removeTabindex = function (e) {
                e.hasAttribute(i.HtmlAttrs.OLDTAB)
                  ? (e.setAttribute('tabindex', e.getAttribute(i.HtmlAttrs.OLDTAB)),
                    e.removeAttribute(i.HtmlAttrs.OLDTAB))
                  : e.removeAttribute('tabindex')
              }),
              (e.prototype.addEvents = function (e) {
                e.hasAttribute(i.HtmlAttrs.COUNTER) ||
                  (this.addEvent(e, 'contextmenu', this.menu.post.bind(this.menu)),
              ...
              (e.prototype.keydown = function (e) {
                e.keyCode === s.KEY.SPACE &&
                  (this.menu.post(e), e.preventDefault(), e.stopImmediatePropagation())
              }),
              e
            )
          })()
            ...
            return (
              ...
              (t.fromJson = function (e, t, n) {
                var r = t.title,
                  ...
                  c = e.get('rule')(e, {}, s),
                  l = o.map(function (t) {
                    return e.get('radio')(e, { content: t, variable: i, id: t }, s)
                  }),
                  u = [a, c].concat(l)
                return (s.items = u), s
              }),
      ...
      2599: function (e, t, n) {
        ...
        function h(e) {
          ...
          return (
            ...
            ((1 === t.length && 'span' === t[0]) ||
              (2 === t.length &&
                (('span' === t[0] && 'join' === t[1]) || ('span' === t[1] && 'join' === t[0]))))
          )
        }
          ...
          for (let r, i = 0; (r = e[i]); i++) {
            ...
            delete s[o.personalityProps.JOIN],
              void 0 !== s[o.personalityProps.PAUSE] &&
                ((e = { [o.personalityProps.PAUSE]: s[o.personalityProps.PAUSE] }),
      ...
      1674: function (e, t, n) {
        ...
        class s extends o.AbstractAudioRenderer {
          ...
          pause(e) {
            let t
            return (
              (t = 'number' == typeof e ? (e <= 250 ? 'short' : e <= 500 ? 'medium' : 'long') : e),
      ...
      4115: function (e, t, n) {
        ...
        class s extends i.XmlRenderer {
          ...
          prosodyElement(e, t) {
            const n =
              (t = Math.floor(this.applyScaleFunction(t))) < 0 ? t.toString() : '+' + t.toString()
            return (
              '<prosody ' +
              e.toLowerCase() +
              '="' +
            ...
            for (let n = 0; n < e.length; n++) {
              ...
              i && !o.MARKS[i] && (t.push('<mark name="' + i + '"/>'), (o.MARKS[i] = !0)),
                1 === r.speech.length && r.speech.match(/[a-zA-Z]/)
                  ? t.push(
                      '<say-as interpret-as="' + o.CHARACTER_ATTR + '">' + r.speech + '</say-as>',
                    )
                  : t.push(r.speech)
            }
      ...
      3539: function (e, t, n) {
        ...
        ;(t.Processor = o),
          (o.LocalState = { walker: null, speechGenerator: null, highlighter: null })
        class i extends o {
          constructor(e, t) {
        ...
        class n {
          static ensureLocale(e, t) {
            return n.LOCALES.get(e)
              ? e
              : (console.error(`Locale ${e} does not exist! Using ${n.LOCALES.get(t)} instead.`), t)
          }
        }
        ;(t.Variables = n),
          (n.VERSION = '4.0.6'),
          ...
          (n.url =
            'https://cdn.jsdelivr.net/npm/speech-rule-engine@' + n.VERSION + '/lib/mathmaps'),
          (n.WGXpath =
          ...
          getMathml() {
            ...
            return (
              ...
              [a, c, o].forEach((e) =>
                i
                  .getInnerNode(e)
                  .setAttribute(s.Attribute.PARENT, this.mml.getAttribute(s.Attribute.ID)),
              ),
            ...
            const c = (e) => {
              for (let t, r = 0; (t = e[r]); r++) {
                ...
                if (e && t === parseInt(i.getInnerNode(e).getAttribute(s.Attribute.ID)))
                  i.getInnerNode(e).setAttribute(s.Attribute.PARENT, this.semantic.id.toString()),
                    o++
                else {
      ...
      7813: function (e, t, n) {
        ...
        n(9775).factory.push(
          ...
          { test: i.CaseEmbellished.test, constr: (e) => new i.CaseEmbellished(e) },
          { test: o.CaseDoubleScript.test, constr: (e) => new o.CaseDoubleScript(e) },
      ...
      8672: function (e, t, n) {
        ...
        function b(e, t, n) {
          ...
          for (; i.length; ) {
            ...
            0 !== t.length &&
              (1 !== t.length
                ? (s ? e.setAttribute('AuxiliaryImplicit', !0) : (s = !0), (i = t.concat(i)))
                : r.push(e))
          }
          const a = [],
        ...
        function E(e, t, n) {
          ...
          let r = t,
            o = R(r)
          for (; o && o.firstChild === r && !r.hasAttribute('AuxiliaryImplicit') && o !== e; )
            (r = o), (o = R(r))
        ...
        function I(e) {
          ...
          return 1 === n.length && l.hasEmptyTag(n[0]) && !n[0].hasAttribute(u.Attribute.TYPE)
            ? I(n[0])
            : e
        }
        function L(e) {
        ...
        function F(e) {
          ...
          return (
            t.appendChild(n), u.setAttributes(t, e), t.setAttribute(u.Attribute.ADDED, 'true'), t
          )
        }
        function k(e, t) {
      ...
      7228: function (e, t, n) {
        ...
        class i {
          ...
          colorize(e) {
            ...
            e.hasAttribute(t) &&
              (e.setAttribute(t + '-old', e.style.color), (e.style.color = e.getAttribute(t)))
          }
          uncolorize(e) {
      ...
      1473: function (e, t, n) {
        ...
        t.StaticTrieNode = class extends i {
          ...
          setRule(e) {
            this.rule_ &&
              r.Debugger.getInstance().output('Replacing rule ' + this.rule_ + ' with ' + e),
              (this.rule_ = e)
          }
          toString() {
            return this.getRule()
        ...
        function h(e) {
          ...
          if (e.match(/^name\(\.\.\/\.\.\)="\w+"$/)) {
            ...
            return (e) => {
              ...
              return (
                (null ===
                  (o = null === (n = e.parentNode) || void 0 === n ? void 0 : n.parentNode) ||
                void 0 === o
                  ? void 0
      ...
      3319: function (e, t, n) {
        ...
        ;(t.nestingToString = function (e) {
          ...
          (t.combinePostfixIndex = function (e, t) {
            return e === r.LOCALE.MESSAGES.MS.ROOTINDEX || e === r.LOCALE.MESSAGES.MS.INDEX
              ? e
              : e + ' ' + t
          }),
          ...
          (t.localeFontCombiner = function (e) {
            return 'string' == typeof e
              ...
              : {
                  font: e[0],
                  combiner:
                    r.LOCALE.COMBINERS[e[1]] || o.Combiners[e[1]] || r.LOCALE.ALPHABETS.combiner,
                }
          })
      },
      8597: function (e, t, n) {
            ...
            c ||
              (c = (function () {
                ...
                return (
                  ...
                  (e.FUNCTIONS.si = (e, t) => (
                    t.match(/^metre/) &&
                      (e = e.replace(/a$/, '\xe0').replace(/o$/, '\xf2').replace(/i$/, '\xed')),
                    e + t
                  )),
            ...
            c ||
              (c = (function () {
                ...
                return (
                  ...
                  (e.FUNCTIONS.si = (e, t) => (
                    t.match(/^metro/) &&
                      (e = e.replace(/a$/, '\xe1').replace(/o$/, '\xf3').replace(/i$/, '\xed')),
                    e + t
                  )),
                  (e.ALPHABETS.combiner = s.Combiners.prefixCombiner),
                  e
      ...
      5571: function (e, t, n) {
        ...
        function o(e, t = !1) {
          ...
          if (((o += i ? r(i, !0) + ' hundrede' : ''), (n %= 100), n))
            if (((o += o ? ' og ' : ''), (i = t ? a.special.smallOrdinals[n] : a.ones[n]), i))
              o += i
            else {
        ...
        function r(e) {
          ...
          return (
            ...
            t &&
              ...
              (n +=
                s.ones[t] ||
                s.tens[Math.floor(t / 10)] + (t % 10 ? s.numSep + s.ones[t % 10] : ''))),
            n
          )
        }
        function o(e) {
      ...
      4394: function (e, t, n) {
        ...
        function s(e) {
          let t = e % 1e3,
            n = ''
          if (
            ((n += u.ones[Math.floor(t / 100)] ? u.ones[Math.floor(t / 100)] + '-cent' : ''),
            (t %= 100),
            t)
          ) {
            n += n ? '-' : ''
          ...
          for (; e > 0; ) {
            ...
            if (r) {
              ...
              if (e && e.match(/^mille /)) {
                ...
                (e = 1 === r && e ? e.replace(/s$/, '') : e), (n = o + (t ? '-' + e + '-' : '') + n)
            }
            ;(e = Math.floor(e / 1e3)), t++
          }
          return n.replace(/-$/, '')
      ...
      1779: function (e, t, n) {
        ...
        function i(e) {
          ...
          if (e < 10)
            return 'f' === t ? s.special.ordinalsFeminine[e] : s.special.ordinalsMasculine[e]
      ...
      1970: function (e, t, n) {
        ...
        class a {
          ...
          evaluateCustom(e) {
            ...
            return void 0 !== t
              ? r.AuditoryDescription.create({ text: t }, { adjust: !0, translate: !1 })
              : null
          }
          evaluateCharacter(e) {
            return (
          ...
          parseCstr(e) {
            try {
              ...
              if ('RuleError' === t.name)
                return (
                  console.error('Rule Error ', `Illegal Dynamic Constraint: ${e}.`, t.message), null
                )
              throw t
            }
          }
          parsePrecondition(e, t) {
            try {
              ...
              if ('RuleError' === n.name)
                return (
                  console.error('Rule Error ', `Illegal preconditions: ${e}, ${t}.`, n.message),
                  null
                )
              throw n
            }
          ...
          parseAction(e) {
            try {
              ...
              if ('RuleError' === t.name)
                return console.error('Rule Error ', `Illegal action: ${e}.`, t.message), null
              throw t
            }
          }
          parse(e) {
      ...
      8310: function (e, t) {
        ...
        class r {
          ...
          toString() {
            const e = []
            return (
              this.order.forEach((t) => e.push(t + ': ' + this.getProperty(t).toString())),
              e.join('\n')
            )
          }
        }
          ...
          match(e) {
            ...
            return (
              ...
              t.every((t) => {
                ...
                return (
                  n === this.reference.getValue(t) || -1 !== this.fallback.getProperty(t).indexOf(n)
                )
              })
            )
          }
      ...
      1058: function (e, t, n) {
        ...
        class a {
          ...
          static translateString_(e) {
            ...
            return (
              (n = null === n ? e : n),
              a.getInstance().getParameter('plural') && (n = s.LOCALE.FUNCTIONS.plural(n)),
              n
            )
          }
          ...
          for (const t of Object.keys(u)) {
            ...
            for (const t of Object.keys(e.mappings)) {
              ...
              for (const o of Object.keys(e.mappings[t]))
                n.mappings[t][o] = i.locales[c]().FUNCTIONS.si(r, e.mappings[t][o])
            }
            y(n)
          }
          y(e)
        ...
        class c extends s.BaseRuleStore {
          ...
          defineSpecializedRule(e, t, n, r) {
            const o = this.parseCstr(t),
              ...
              s = this.parseCstr(n)
            if (!i && r)
              throw new a.OutputError('Rule named ' + e + ' with style ' + t + ' does not exist.')
          ...
          evaluateString(e) {
            ...
            for (let e, r = 0; (e = i[r]); r++)
              ...
              else if (e.match(new RegExp('^[' + o.LOCALE.MESSAGES.regexp.TEXT + ']+$')))
      ...
      6060: function (e, t, n) {
        ...
        class b {
          ...
          static debugSpeechRule(e, t) {
            ...
            o.Debugger.getInstance().output(n.query, r ? r.toString() : r),
              n.constraints.forEach((n) =>
                o.Debugger.getInstance().output(n, e.context.applyConstraint(t, n)),
              )
          }
          ...
          addStore(e) {
            const t = S(e)
            'abstract' !== t.kind && t.getSpeechRules().forEach((e) => this.trie.addRule(e)),
              this.addEvaluator(t)
          }
          ...
          getEvaluator(e, t) {
            const n =
              this.evaluators_[e] || this.evaluators_[p.DynamicCstr.DEFAULT_VALUES[p.Axis.LOCALE]]
          ...
          evaluateTree_(e) {
            ...
            let n
            o.Debugger.getInstance().output(t.mode !== a.Mode.HTTP ? e.toString() : e),
            ...
            for (let t, o = 0; (t = u[o]); o++) {
              ...
              o[0] &&
                !u &&
                (a.context &&
                  (o[0].context = l.constructString(e, a.context) + (o[0].context || '')),
          ...
          evaluateNodeList_(e, t, n, o, i, s) {
            ...
            for (let e, n = 0; (e = t[n]); n++) {
              ...
              if (
                r.length > 0 &&
                ((r[0].context = u() + (r[0].context || '')), (h = h.concat(r)), n < t.length - 1)
              ) {
                const e = p()
                h = h.concat(e)
              }
          ...
          addPersonality_(e, t, n, o) {
            ...
            for (let t, n = 0; (t = e[n]); n++)
              this.addRelativePersonality_(t, i), this.addExternalAttributes_(t, o)
            if (
              (n && e.length && delete e[e.length - 1].personality[a.personalityProps.JOIN],
              s && e.length)
            ) {
          ...
          updateConstraint_() {
            ...
            n.hasSubtrie([o, i, a]) ||
              ...
              (r[p.Axis.LOCALE] = [o]),
              (r[p.Axis.MODALITY] = [
                'summary' !== i ? i : p.DynamicCstr.DEFAULT_VALUES[p.Axis.MODALITY],
              ]),
              (r[p.Axis.DOMAIN] = [
                'speech' !== i ? p.DynamicCstr.DEFAULT_VALUES[p.Axis.DOMAIN] : a,
              ])
            const c = e.getOrder()
          ...
          lookupRule(e, t) {
            if (
              !e ||
              (e.nodeType !== i.NodeType.ELEMENT_NODE && e.nodeType !== i.NodeType.TEXT_NODE)
            )
              return null
        ...
        ;(t.storeFactory = S),
          (s.default.nodeEvaluator = b.getInstance().evaluateNode.bind(b.getInstance()))
      },
      3686: function (e, t) {
        Object.defineProperty(t, '__esModule', { value: !0 }),
        ...
        ;(t.nodeCounter = function (e, t) {
          ...
          (t.pauseSeparator = function (e, t) {
            const n = parseFloat(t),
              o = isNaN(n) ? t : n
            return function () {
              return [r.AuditoryDescription.create({ text: '', personality: { pause: o } })]
            }
          }),
      ...
      4020: function (e, t) {
        ...
        const fe = String.fromCodePoint(8289),
          ...
          ye = [
            ...
            { set: x, type: 'identifier', role: 'latinletter', font: 'fraktur' },
            { set: T, type: 'identifier', role: 'latinletter', font: 'fraktur' },
            { set: L, type: 'identifier', role: 'latinletter', font: 'double-struck' },
            { set: I, type: 'identifier', role: 'latinletter', font: 'double-struck' },
            { set: R, type: 'identifier', role: 'latinletter', font: 'bold-fraktur' },
            { set: P, type: 'identifier', role: 'latinletter', font: 'bold-fraktur' },
            { set: D, type: 'identifier', role: 'latinletter', font: 'sans-serif' },
            { set: w, type: 'identifier', role: 'latinletter', font: 'sans-serif' },
            { set: k, type: 'identifier', role: 'latinletter', font: 'sans-serif-bold' },
            { set: F, type: 'identifier', role: 'latinletter', font: 'sans-serif-bold' },
            ...
            { set: V, type: 'identifier', role: 'latinletter', font: 'sans-serif-bold-italic' },
            { set: j, type: 'identifier', role: 'latinletter', font: 'sans-serif-bold-italic' },
            { set: G, type: 'identifier', role: 'latinletter', font: 'monospace' },
            { set: H, type: 'identifier', role: 'latinletter', font: 'monospace' },
            { set: $, type: 'identifier', role: 'latinletter', font: 'double-struck-italic' },
            ...
            { set: z, type: 'identifier', role: 'greekletter', font: 'bold-italic' },
            ...
            { set: oe, type: 'identifier', role: 'greekletter', font: 'normal' },
        ...
        class c extends s {
          ...
          reduce() {
            for (const e in this.map)
              1 !== this.map[e].length && (this.map[e] = (0, o.reduce)(this.map[e]))
          }
          default() {
            const e = new i()
      ...
      7103: function (e, t, n) {
        ...
        function p(e, t, n) {
          ...
          if (!o)
            return r.Debugger.getInstance().output('Juxta Heuristic Case 3'), p([i].concat(a), t, n)
          const l = a.shift()
          if (!l) {
            r.Debugger.getInstance().output('Juxta Heuristic Case 9')
            const a = s.factory.makeBranchNode('infixop', [o, t.shift()], [i], i.textContent)
            return (
              (a.role = 'implicit'), s.run('combine_juxtaposition', a), t.unshift(a), p(e, t, n)
            )
          }
            ...
            new a.SemanticMultiHeuristic('convert_juxtaposition', (e) => {
              ...
              ;(t = t.rel.length
                ? (function (e) {
                    ...
                    for (; e.comp.length; )
                      if (((i = []), r.length))
                        o && t.push(o), n.push(r), (o = e.rel.shift()), (r = e.comp.shift())
                      else {
      ...
      8122: function (e, t, n) {
        ...
        class c extends o.SemanticAbstractParser {
          ...
          root_(e, t) {
            return t[1]
              ? this.getFactory().makeBranchNode('root', [this.parse(t[1]), this.parse(t[0])], [])
              : this.sqrt_(e, t)
          }
          sqrt_(e, t) {
          ...
          text_(e, t) {
            ...
            return e.textContent
              ? (n.updateContent(e.textContent, !0), s.default.getInstance().text(n, r.tagName(e)))
              : n
          }
          identifier_(e, t) {
            const n = this.leaf_(e, t)
          ...
          static processChildren(e, t) {
            for (const n of r.toArray(t.childNodes)) {
              ...
              t.forEach((t) => (t.parent = e)),
                'CONTENT' === r.tagName(n) ? (e.contentNodes = t) : (e.childNodes = t)
            }
          }
          querySelectorAll(e) {
            let t = []
        ...
        function h(e) {
          return (
            ...
            (!(function (e) {
              return (
                i(e, 'tensor') &&
                (!i(e.childNodes[1], 'empty') || !i(e.childNodes[2], 'empty')) &&
            ...
            return (
              ...
              (!e.embellished ||
                ('superscript' !== e.type &&
                  'subscript' !== e.type &&
                  ('tensor' !== e.type ||
                    ('empty' === e.childNodes[3].type && 'empty' === e.childNodes[4].type))))
            )
          }),
        ...
        class l {
                ...
                (2 === t.length &&
                  (l.testColumns_(t, 1, (e) => l.isEndRelation_(e, n) || l.isPureRelation_(e, n)) ||
                    l.testColumns_(
                      t,
                      0,
                      (e) => l.isEndRelation_(e, n, !0) || l.isPureRelation_(e, n),
                    )))
              ) && ((e.role = n), !0)
            )
          }
          ...
          fractionLikeNode(e, t, n, r) {
            ...
            if (!r && c.isZeroLength(n)) {
              ...
              return (
                (o = l.getInstance().factory_.makeBranchNode('multiline', [n, r], [])),
                l.binomialForm_(o),
          ...
          inference(e, t, n) {
            if (t.inferenceRule) {
              ...
              return l
                .getInstance()
                .factory_.makeBranchNode('inference', [t.conclusion, t.premises], [])
            }
            ...
            const a = l.getInstance().getFormulas(e, i, n),
              c = l
                .getInstance()
                .factory_.makeBranchNode('inference', [a.conclusion, a.premises], s)
          ...
          getLabel(e, t, n, o) {
            const i = l.getInstance().findNestedRow(t, 'prooflabel', o),
              s = l
                .getInstance()
                .factory_.makeBranchNode('rulelabel', n(r.toArray(i.childNodes)), [])
          ...
          implicitNode_(e) {
            const t = l
              .getInstance()
              .factory_.makeMultipleContentNodes(e.length - 1, o.invisibleTimes())
            l.matchSpaces_(e, t)
          ...
          infixNode_(e, t) {
            const n = l
              .getInstance()
              .factory_.makeBranchNode('infixop', e, [t], c.getEmbellishedInner(t).textContent)
          ...
          combineUnits_(e) {
            ...
            do {
              ...
              let i = null
              ;(o = n.pop()),
                o && (e.length && a.isUnitCounter(o) ? e.unshift(o) : n.push(o)),
                1 === e.length && (i = e.pop()),
                e.length > 1 && ((i = l.getInstance().implicitNode_(e)), (i.role = 'unit')),
                i && n.push(i),
                r && n.push(r)
            } while (r)
            return n
          ...
          appendExistingOperator_(e, t, n) {
            return (
              ...
              (e.contentNodes[0].equals(t)
                ...
                : l
                    .getInstance()
                    .appendExistingOperator_(e.childNodes[e.childNodes.length - 1], t, n))
            )
          }
          getFencesInRow_(e) {
          ...
          fences_(e, t, n, r) {
            ...
            if (
              'open' === s ||
              (a.isNeutralFence(e[0]) && (!i || !a.compareNeutralFences(e[0], i)))
            ) {
              n.push(e.shift())
              const o = t.shift()
            ...
            if (i && 'close' === s && a.isNeutralFence(i) && n.some(o)) {
              ...
              return (
                r.push(r.pop().concat([d], t.shift())), l.getInstance().fences_(e, t, i.head, r)
              )
            }
            const u = e.shift()
            return (
          ...
          dummyNode_(e) {
            const t = l
              .getInstance()
              .factory_.makeMultipleContentNodes(e.length - 1, o.invisibleComma())
            return (
              t.forEach(function (e) {
                e.role = 'dummy'
              }),
          ...
          accentNode_(e, t, n, r, o) {
            ...
            if (
              (!o &&
                s &&
                ((a = l.getInstance().factory_.makeBranchNode('subscript', [e, i], [])),
                (a.role = 'subsup'),
                (t = [a, s]),
                (n = 'superscript')),
              o)
              ...
              if (s) {
                l.getInstance().accentRole_(s, 'overscore') && !r
                  ? ((a = l.getInstance().factory_.makeBranchNode('overscore', [e, s], [])),
                    (t = [a, i]),
                    (n = 'underscore'))
                  : ((a = l.getInstance().factory_.makeBranchNode('underscore', [e, i], [])),
                    (t = [a, s]),
                    (n = 'overscore')),
                  (a.role = 'underover')
              }
          ...
          getFunctionArgs_(e, t, n) {
            ...
            switch (n) {
              case 'integral': {
                ...
                return (
                  (i = l.getInstance().integralNode_(e, r, n.intvar)), n.rest.unshift(i), n.rest
                )
              }
              case 'prefix':
        ...
        class s {
            ...
            return e.reduce((e, t) => {
              return e.concat(
                ...
                s.simpleCollapseStructure(n)
                  ? [n]
                  : ((n = n), s.contentCollapseStructure(n[1]) ? n.slice(2) : n.slice(1))),
              )
              var n
            }, [])
          }
          ...
          directChildren(e) {
            ...
            return this.levelsMap[e]
              .slice(1)
              .map((e) =>
                s.simpleCollapseStructure(e) ? e : s.contentCollapseStructure(e) ? e[1] : e[0],
              )
          }
          subtreeNodes(e) {
            if (!this.isRoot(e)) return []
      ...
      8662: function (e, t, n) {
        ...
        function f(e) {
          return (
            ...
            (y(e.childNodes[1]) ||
              ('fenced' === e.childNodes[1].type && y(e.childNodes[1].childNodes[0])))
          )
        }
        function m(e) {
          return (
        ...
        function M(e) {
          return (
            'number' === e.tagName && e.hasAttribute('role') && 'integer' === e.getAttribute('role')
          )
        }
        function O(e) {
        ...
        ;(t.nodeCounter = function (e, t) {
          ...
          (t.nestingDepth = function (e) {
            ...
            let i = e.parentNode
            for (; i; )
              'fenced' === i.tagName && i.childNodes[0].childNodes[o].textContent === r && n++,
                (i = i.parentNode)
              ...
              (L(n[o + 1]) ||
                ...
                ('superscript' === n[o + 1].tagName &&
                  ...
                  ('number' === n[o + 1].childNodes[0].childNodes[0].tagName ||
                    'identifier' === n[o + 1].childNodes[0].childNodes[0].tagName) &&
      ...
      3269: function (e, t, n) {
        ...
        function y(e) {
          const t =
            'sqrt' === e.tagName ? '2' : i.evalXPath('children/*[1]', e)[0].textContent.trim()
        ...
        ;(t.spaceoutText = function (e) {
          ...
          (t.baselineBrief = function (e) {
            return (
              m(e, '', { sup: s.LOCALE.MESSAGES.MS.SUP, sub: s.LOCALE.MESSAGES.MS.SUB }) ||
      ...
      9570: function (e, t, n) {
        ...
        function h(e, t) {
          const n = t || 0
          return e.parentNode
            ? h(e.parentNode, 'root' === e.tagName || 'sqrt' === e.tagName ? n + 1 : n)
            : n
        }
        function f(e) {
          const t = '\u2820'
        ...
        class N {
            ...
            ;(this.node = e),
              ...
              this.node.id
                ...
                : this.node.hasAttribute(N.SRE_ID_ATTR)
                  ...
                  : (this.node.setAttribute(N.SRE_ID_ATTR, N.ID_COUNTER.toString()),
          ...
          move(e) {
            ...
            return (
              !(!n || n === this.getFocus()) &&
              (this.setFocus(n),
              this.moved === y.WalkerMoves.HOME && (this.levels = this.initLevels()),
              !0)
            )
          }
          up() {
          ...
          depth() {
            return (
              (this.moved = this.isSpeech() ? y.WalkerMoves.DEPTH : y.WalkerMoves.REPEAT),
              this.getFocus().clone()
            )
          }
          home() {
          ...
          rebuildStree() {
            ;(this.rebuilt_ = new b.RebuildStree(this.getXml())),
              ...
              (this.skeleton = p.SemanticSkeleton.fromTree(this.rebuilt_.stree)),
          ...
          summary() {
            return (
              (this.moved = this.isSpeech() ? y.WalkerMoves.SUMMARY : y.WalkerMoves.REPEAT),
              this.getFocus().clone()
            )
          }
          detail() {
            return (
              (this.moved = this.isSpeech() ? y.WalkerMoves.DETAIL : y.WalkerMoves.REPEAT),
              this.getFocus().clone()
            )
          }
          specialMove() {
            ...
            const e = this.getFocus().getSemanticPrimary().id.toString(),
              t =
                this.getRebuilt().xml.getAttribute('id') === e
                  ? this.getRebuilt().xml
                  : i.querySelectorAllByAttrValue(this.getRebuilt().xml, 'id', e)[0],
          ...
          collapsedChildren_(e) {
            const t = (e) => {
              ...
              for (let r = 1, o = e.length; r < o; r++) {
                const o = e[r]
                n.childNodes.push(
                  c.SemanticSkeleton.simpleCollapseStructure(o) ? this.nodeDict[o] : t(o),
                )
              }
              return n
            }
      ...
      4051: function (e, t, n) {
        ...
        class a extends i.SyntaxWalker {
          ...
          eligibleCell_() {
            ...
            return (
              this.modifier && 'cell' === e.type && -1 !== a.ELIGIBLE_CELL_ROLES.indexOf(e.role)
            )
          }
          verticalMove_(e) {
