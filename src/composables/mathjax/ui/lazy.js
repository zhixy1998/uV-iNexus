      ...
      335: function (t, e, r) {
            ...
            (r = (function (t) {
              function r() {
                ...
                !n.has('lazyAlways') && n.allocate('lazyAlways'),
                  (a.lazyObserver = new IntersectionObserver(a.lazyObserve.bind(a), {
              ...
              return (
                ...
                (r.prototype.state = function (e, r) {
                  return (
                    ...
                    e < c.STATE.LAZYALWAYS && this.processed.clear('lazyAlways'),
                    this
                  )
                }),
                        ...
                        for (e = u(this.math), r = e.next(); !r.done; r = e.next())
                          (a = r.value),
                            ((n = a).lazyCompile || n.lazyTypeset) &&
                              (n.lazyCompile
                                ? (n.state(c.STATE.COMPILED - 1), (t = c.STATE.COMPILED))
                  ...
                  try {
                    for (var n = u(t), o = n.next(); !o.done; o = n.next()) {
                      ...
                      this.lazyList.get(l) &&
                        (i.isIntersecting
                          ? (this.lazySet.add(l),
                            this.lazyIdle || ((this.lazyIdle = !0), this.lazyProcessSet()))
                ...
                (r.prototype.resetStates = function (t, e) {
                  ...
                  try {
                    for (var n = u(t.values()), o = n.next(); !o.done; o = n.next()) {
                      ...
                      l.lazyCompile
                        ? (l.state(c.STATE.COMPILED - 1), (e = c.STATE.COMPILED))
                        : l.state(c.STATE.TYPESET - 1),
                        (l.lazyCompile = l.lazyTypeset = !1),
                        l.lazyMarker && this.lazyObserver.unobserve(l.lazyMarker)
                    }
                  } catch (t) {
                    r = { error: t }
                  } finally {
                  ...
                  try {
                    for (var i = u(o), l = i.next(); !l.done; l = i.next()) {
                      ...
                      s &&
                        ...
                        this.lazyList.delete(this.adaptor.getAttribute(s, e.LAZYID)))
                    }
                  } catch (t) {
                    a = { error: t }
                  } finally {
                ...
                (r.prototype.render = function () {
                  ...
                  return (
                    (this.lazyAlwaysContainers = e
                      ? this.adaptor.getElements(Array.isArray(e) ? e : [e], this.document)
                      : null),
        ...
        ;(e.LazyList = p),
          ...
          (e.LazyHandler = function (t) {
            return (
              'undefined' != typeof IntersectionObserver && (t.documentClass = d(t.documentClass)),
              t
            )
          })
      },
