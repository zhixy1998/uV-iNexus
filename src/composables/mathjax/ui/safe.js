!(function () {
              ...
              function e() {
                ...
                try {
                  for (var u = s(i.inputJax), p = u.next(); !p.done; p = u.next()) {
                    var c = p.value
                    c.name.match(/MathML/)
                      ? ((c.mathml.filterAttribute = i.safe.mmlAttribute.bind(i.safe)),
              ...
              try {
                for (var p = n(Object.keys(s.safeStyles)), c = p.next(); !c.done; c = p.next()) {
                  ...
                  if (s.styleParts[h])
                    try {
                      for (
                        var d = ((i = void 0), n(['Top', 'Right', 'Bottom', 'Left'])), y = d.next();
                        !y.done;
                        y = d.next()
                      ) {
                        var m,
            ...
            return (
                ...
                try {
                  for (var i = a(Object.keys(n)), o = i.next(); !o.done; o = i.next()) {
                    ...
                    if (s) {
                      ...
                      f
                        ? f !== ('number' == typeof f ? parseFloat(n[l]) : n[l]) && (n[l] = f)
                        : delete n[l]
                    }
                  }
                } catch (t) {
              ...
              (t.prototype.mmlAttribute = function (t, e) {
                ...
                var r =
                  ...
                  ('data-' === t.substr(0, 5) ? this.filterAttributes.get('data-') : null)
                if (!r) return e
  ...
  ;(t = l(723)),
    ...
    (0, t.r8)({ _: { ui: { safe: { SafeHandler: r, SafeMethods: n, safe: a } } } }),
    MathJax.startup &&
