          ...
          l = (function (t) {
            ...
            return (
              ...
              (e.prototype.setChildInheritedAttributes = function (e, r, n, o) {
                ...
                try {
                  for (
                    var l = a([this.open, this.close].concat(this.separators)), u = l.next();
                    !u.done;
                    u = l.next()
                  ) {
                    var c = u.value
                ...
                if (!this.processed.isSet('findMath')) {
                  ...
                  try {
                    for (
                      ...
                      try {
                        for (
                          var v = ((n = void 0), s(this.inputJax)), m = v.next();
                          !m.done;
                          m = v.next()
                        ) {
                          var b = m.value,
                          ...
                          if (b.processStrings) {
                            ...
                            try {
                              for (
                                var L = ((l = void 0), s(b.findMath(M))), N = L.next();
                                !N.done;
                                N = L.next()
                              ) {
                                var R = N.value
                            ...
                            try {
                              for (
                                var T = ((p = void 0), s(b.findMath(y))), S = T.next();
                                !S.done;
                                S = T.next()
                              ) {
                                R = S.value
          ...
          return (
            ...
            (t.prototype.remove = function () {
              ...
              for (var c = this.list.next; c.data !== e.END; ) {
                var p = c.next
                a.has(c.data) &&
                  ((c.prev.next = c.next), (c.next.prev = c.prev), (c.next = c.prev = null)),
                  (c = p)
              }
            }),
            (t.prototype.clear = function () {
