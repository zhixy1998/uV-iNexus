      ...
      244: function (t, e, n) {
        ...
        ;(e.NodeMixinOptions = { badCSS: !0, badSizes: !0 }),
          (e.NodeMixin = function (t, n) {
            ...
            return (
              void 0 === n && (n = {}),
              (n = (0, a.userOptions)((0, a.defaultOptions)({}, e.NodeMixinOptions), n)),
              (r = (function (t) {
                function e() {
                  ...
                  var r = t.call(this, e[0]) || this,
                    o = r.constructor
                  return (
                    (r.options = (0, a.userOptions)((0, a.defaultOptions)({}, o.OPTIONS), e[1])), r
                  )
                }
                return (
                  o(e, t),
                ...
                a && this.addText(n, o, a),
                  l &&
                    ...
                    ('!' === l.charAt(1)
                      ...
                      : (o =
                          '/' === l.charAt(1) ? this.closeTag(n, o, l) : this.openTag(n, o, l, i)))
              }
          ...
          b = (function (t) {
            ...
            return (
                    ...
                    if ('string' == typeof s)
                      if ('#' === s.charAt(0)) {
                        ...
                        '.' === s.charAt(0)
                          ...
                          : s.match(/^[-a-z][-a-z0-9]*$/i) && (o = o.concat(this.tags(i, s)))
                    else
                      Array.isArray(s)
                        ? (o = o.concat(s))
              ...
              (e.prototype.replace = function (t, e) {
                var n = this.childIndex(e)
                return (
                  n >= 0 && ((e.parent.children[n] = t), (t.parent = e.parent), (e.parent = null)),
                  e
                )
              }),
              ...
              (e.prototype.textContent = function (t) {
                ...
                return t.children.reduce(function (t, n) {
                  return (
                    t +
                    ('#text' === n.kind ? n.value : '#comment' === n.kind ? '' : e.textContent(n))
                  )
                }, '')
              }),
