          ...
          (function (t) {
            ...
            e.Ajax = {
              ...
              fileURL: function (t) {
                ...
                return (
                  e && e[1] in r && (t = (r[e[1]] || this.config.root) + t.substr(e[1].length + 2)),
                  t
                )
              },
              fileName: function (t) {
            ...
            ;(t.mbase = MathJax.Object.Subclass(
              {
                ...
                getPrevClass: function (t) {
                  t &&
                    ((this.prevClass = t.Get('texClass')), (this.prevLevel = t.Get('scriptlevel')))
                },
          ...
          function O(t) {
            ...
            return (
              (u && a > 1) || a > 2
                ...
                : ((a = 2),
                  (n =
                    ('A' > (i = t.slice(0, 1)) || i > 'Z') && ('a' > i || i > 'z') ? 'mo' : 'mi')),
              '-' == i && ' ' !== t.charAt(1) && 3 == b
              ...
              case 1:
                ...
                if ('boolean' == typeof e.func && e.func)
                  return '^' == (r = t.charAt(0)) ||
                    ...
                    : ((i = d('mrow', d(e.tag, n.createTextNode(e.output)))).appendChild(a[0]),
                      [i, a[1]])
                if ((L(a[0]), 'sqrt' == e.input)) return [d(e.tag, a[0]), a[1]]
                if (void 0 !== e.rewriteleftright)
                  return (
                    (i = d('mrow', d('mo', n.createTextNode(e.rewriteleftright[0])))).appendChild(
                      a[0],
                    ),
                    i.appendChild(d('mo', n.createTextNode(e.rewriteleftright[1]))),
                    [i, a[1]]
                  )
                if ('cancel' == e.input)
                  return (
                    (i = d(e.tag, a[0])).setAttribute('notation', 'updiagonalstrike'), [i, a[1]]
                  )
          ...
          !(function () {
            ...
            t.Augment({
              AM: {
                ...
                document: n,
                define: function (t, e) {
                  x.push({ input: t, tag: 'mo', output: e, tex: null, ttype: y }), A()
                },
