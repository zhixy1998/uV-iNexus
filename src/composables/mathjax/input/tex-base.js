        ...
        !(function (t) {
          ;(t.variable = function (t, e) {
            ...
            (t.environment = function (t, e, r, o) {
              var a = o[0],
                s = t.itemFactory.create('begin').setProperties({ name: e, end: a })
                ...
                if (
                  ...
                  (!l.default.isType(i, 'TeXAtom') ||
                    (l.default.getChildren(i)[0] &&
                      l.default.getChildren(l.default.getChildren(i)[0]).length))
                ) {
                  if (
                    l.default.isEmbellished(i) ||
                    (l.default.isType(i, 'TeXAtom') && l.default.getTexClass(i) === s.TEXCLASS.REL)
                  ) {
                  ...
                  if ('$' === (i = e.charAt(f++)))
                    '$' === h && 0 === d
                      ? ((o = t.create('node', 'TeXAtom', [
                        ...
                        (p = f))
                      : '' === h &&
                        (p < f - 1 && l.push(g(t, e.slice(p, f - 1), s)), (h = '$'), (p = f))
                  else if ('{' === i && '' !== h) d++
                  else if ('}' === i)
                    if ('}' === h && 0 === d) {
                  ...
                  try {
                    for (var i = u(n.getList('nonscript')), o = i.next(); !o.done; o = i.next()) {
                      ...
                      if (a.attributes.get('scriptlevel') > 0) {
                        ...
                        a.isKind('mrow') &&
                          (a.parent.replaceChild(a.childNodes[0], a), n.removeFromList('mrow', [a]))
                    }
                  } catch (t) {
                    e = { error: t }
                  } finally {
          ...
          return (
            ...
            (e.prototype.addRowSpacing = function (t) {
              if (this.arraydef.rowspacing) {
                ...
                ;(e[this.table.length - 1] = p.default.Em(Math.max(0, n + p.default.dimen2em(t)))),
                  (this.arraydef.rowspacing = e.join(' '))
              }
            }),
            e
      ...
      724: function (t, e, r) {
        ...
        ;(x.Open = function (t, e) {
          ...
          (x.SetSize = function (t, e, r) {
            ;(t.stack.env.size = r),
              t.Push(
                t.itemFactory.create('style').setProperty('styles', { mathsize: (0, g.em)(r) }),
              )
          }),
          ...
          (x.Entry = function (t, e) {
            ...
            if (r.getProperty('isCases') || n) {
              for (
                ...
                var c = i.charAt(s)
                if ('{' === c) o++, s++
                else if ('}' === c) 0 === o ? (l = 0) : (0 === --o && a < 0 && (a = s - t.i), s++)
                else {
                  if ('&' === c && 0 === o)
