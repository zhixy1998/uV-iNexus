;(function () {
  ...
  var __webpack_modules__ = {
      ...
      514: function (e, t, l) {
        var s,
          n =
            ...
            function (e, t) {
              ...
              s(e, t),
                (e.prototype =
                  null === t ? Object.create(t) : ((l.prototype = t.prototype), new l()))
            }),
          m =
            (this && this.__assign) ||
            function () {
        ...
        var c = l(63),
          i = (function () {
            function e(t) {
              if ('undefined' == typeof XSLTProcessor) this.transform = (0, c.createTransform)()
              else {
  ...
  ;(global = __webpack_require__(955)),
    ...
    MathJax.loader && MathJax.loader.checkVersion('[mml]/mml3', version.q, 'input/mml/extensions'),
    (0, global.r8)({ _: { input: { mathml: { mml3: { 'mml3-node': mml3_node, mml3: mml3 } } } } }),
    MathJax.startup &&
