!(function () {
          ...
          s = (function (t) {
            ...
            return (
              ...
              (e.prototype.toMml = function () {
                ...
                var o = { fence: !0, stretchy: !1, symmetric: !0, texClass: l.TEXCLASS.OPEN },
            ...
            if ('braket' !== r.kind || r.getProperty('barcount') >= r.getProperty('barmax')) {
              ...
              if (
                ...
                t.Push(i),
                  ...
                  (i = t.create('token', 'mo', { stretchy: !0, braketbar: !0 }, a)),
                  t.Push(i),
  ...
  ;(t = l(955)),
    ...
    (0, t.r8)({
      _: {
        input: { tex: { braket: { BraketConfiguration: a, BraketItems: r, BraketMethods: o } } },
      },
    })
})()
