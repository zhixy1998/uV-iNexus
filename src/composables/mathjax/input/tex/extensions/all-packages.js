      ...
      8016: function (t, e, r) {
        ...
        ;(e.AmsMethods = {}),
              ...
              (o
                ? n.replaceChild(
                    t.create('node', 'mphantom', [
                      t.create('node', 'mpadded', [i.default.copyNode(d, t)], { width: 0 }),
                    ]),
          ...
          (e.AmsMethods.xArrow = function (t, e, r, n, a) {
            var o = { width: '+' + i.default.Em((n + a) / 18), lspace: i.default.Em(n / 18) },
              s = t.GetBrackets(e),
              c = t.ParseArg(e),
        ...
        var a = n(r(2193)),
          ...
          l = {
            ...
            arrow: function (t, e) {
              ...
              for (
                var c, u = n, d = u.table.length % 2 == 1, p = (u.row.length + (d ? 0 : 1)) % 2;
                p;
      ...
      5275: function (t, e, r) {
        ...
        function d(t, e, r, o) {
          ...
          if (c.Package.packages.has(t.options.require.prefix + r)) {
            ...
            ;(t.string = (o ? e + ' ' : '\\begin{' + e.slice(1) + '}') + t.string.slice(t.i)),
              (t.i = 0)
          }
          ;(0, l.RequireLoad)(t, r)
        }
          ...
          c = (function (t) {
            ...
            return (
              ...
              (e.prototype.toMml = function () {
                ...
                var a = { fence: !0, stretchy: !1, symmetric: !0, texClass: s.TEXCLASS.OPEN },
          ...
          (s.Bar = function (t, e) {
            ...
            if ('braket' !== n.kind || n.getProperty('barcount') >= n.getProperty('barmax')) {
              ...
              if (
                ...
                var i = t.create('node', 'TeXAtom', [], { texClass: o.TEXCLASS.CLOSE })
                t.Push(i),
                  n.setProperty('barcount', n.getProperty('barcount') + 1),
                  (i = t.create('token', 'mo', { stretchy: !0, braketbar: !0 }, r)),
                  t.Push(i),
                  (i = t.create('node', 'TeXAtom', [], { texClass: o.TEXCLASS.OPEN })),
                  t.Push(i)
              } else {
        ...
        ;(f.Inference = function (t, e, r) {
          ...
          do {
            i.length && i.unshift(t.create('node', 'mtd', [], {})),
              i.unshift(t.create('node', 'mtd', [n.Pop()], { rowalign: a ? 'top' : 'bottom' })),
              r--
          } while (r > 0)
      ...
      378: function (t, e, r) {
        ...
        var s = i(r(4748)),
          ...
          C = function (t, r, n, a, o) {
            var i = t.nodeFactory.create('node', 'mspace', [], { width: l.default.Em(o) })
            if ('left' === a) {
            ...
            for (var s = o(i), l = s.next(); !l.done; l = s.next()) {
              ...
              if (null != (0, e.getProperty)(k, 'inference')) {
                ...
                if (!d && (I = y(c))) {
                  var N = x(I)
                  if (N) {
                    var D = a.nodeFactory.create('node', 'mspace', [], { width: q - T + 'em' })
        ...
        e.ConfigMacrosConfiguration = i.Configuration.create('configmacros', {
          init: function (t) {
            new l.CommandMap(f, {}, {}),
              ...
              t.append(
                i.Configuration.local({ handler: { macro: [f], environment: [m] }, priority: 3 }),
              )
          },
          config: function (t, e) {
            !(function (t) {
            ...
            Empheq: function (t, e) {
              if (t.stack.env.closing === e.getName()) {
                ...
                n && e.setProperties(f.EmpheqUtil.splitOptions(n, { left: 1, right: 1 })),
                  ...
                  (t.string =
                    '\\begin{' + o + '}' + (s ? '{' + s + '}' : '') + t.string.slice(t.i)),
                  (t.i = 0),
                  t.Push(e)
              }
            },
          ...
          rowspanCell: function (t, e, r, n, a) {
            t.appendChild(
              n.create(
                'node',
                'mpadded',
                [this.cellBlock(e, s.default.copyNode(r, n), n, a), this.topRowTable(r, n)],
            ...
            try {
              for (
                ...
                ;(l = n.create('node', 'mtd')),
                  ...
                  (l.parent = d),
                  d.isKind('mlabeledtr') &&
                    ((d.childNodes[0] = d.childNodes[1]), (d.childNodes[1] = l))
              }
            } catch (t) {
              i = { error: t }
            } finally {
              ...
              if (p.getProperty('fixPrescript')) {
                ...
                try {
                  for (var h = ((n = void 0), a([1, 2])), g = h.next(); !g.done; g = h.next()) {
                    f[(x = g.value)] ||
                      (l.default.setChild(p, x, c.nodeFactory.create('node', 'none')), m++)
                  }
                } catch (t) {
                  n = { error: t }
                } finally {
            ...
            return (
              ...
              (e.prototype.EndTable = function () {
                if (
                  ...
                  s.default.getAttribute(o, 'columnalign') !== l.TexConstant.Align.RIGHT &&
                    o.appendChild(this.create('node', 'mspace', [], { width: n }))
      ...
      2178: function (t, e, r) {
        ...
        e.MathtoolsMethods = {
          ...
          MtLap: function (t, e, r) {
            ...
            'r' !== r && p.default.setAttribute(a, 'lspace', 'l' === r ? '-1width' : '-.5width'),
              t.Push(a)
          },
          ...
          PairedDelimiters: function (t, e, r, n, o, i, l, c) {
            ...
            ;(o = o.replace(/\\delimsize/g, h)),
              (t.string = [l, f, r, o, m, n, c, t.string.substr(t.i)].reduce(function (e, r) {
          ...
          Prescript: function (t, e) {
            ...
            if (p.default.isType(r, 'none') && p.default.isType(n, 'none')) t.Push(a)
              ...
              p.default.getChildren(o).push(null, null),
                p.default.appendChildren(o, [t.create('node', 'mprescripts'), n, r]),
          ...
          setDisplayLevel: function (t, e) {
            if (e) {
              var r = n(
                ...
                o = r[1]
              null !== a &&
                (t.attributes.set('displaystyle', a), t.attributes.set('scriptlevel', o))
            }
          },
              ...
              null == a
                ? r
                  ...
                  : '\\left\\vert{'
                      ...
                      .concat(n, '}\\right\\vert')
                : r
                  ? '\\vert{'.concat(n, '}\\rangle\\!\\langle{').concat(a, '}\\vert')
                  : '\\left\\vert{'
                      .concat(n, '}\\middle\\rangle\\!\\middle\\langle{')
                      .concat(a, '}\\right\\vert')),
              t.Push(new i.default(o, t.stack.env, t.configuration).mml())
                ...
                try {
                  for (var c = n(Object.keys(i)), u = c.next(); !u.done; u = c.next()) {
                    ...
                    s.filterOption(t, o, d) &&
                      (('tex' === o ? t.options : t.options[o])[d] = s.filterValue(t, o, d, i[d]))
                  }
                } catch (t) {
                  r = { error: t }
                } finally {
      ...
      3762: function (t, e, r) {
        ...
        r(5557),
          ...
          (e.TextMacrosConfiguration = o.Configuration.create('textmacros', {
            config: function (t, e) {
              var r = new o.ParserConfiguration(e.parseOptions.options.textmacros.packages, [
                'tex',
                'text',
              ])
              r.init()
      ...
      8768: function (t, e, r) {
        ...
        ;(e.VerbMethods = {}),
          (e.VerbMethods.Verb = function (t, e) {
            ...
            t.i++,
              t.Push(
                t.create('token', 'mtext', { mathvariant: o.TexConstant.Variant.MONOSPACE }, a),
              )
          }),
              ...
              ce: {
                ...
                actions: {
                  ...
                  '- after o/d': function (t, e, r) {
                    ...
                    return (
                      l
                        ? (a.concatArray(c, this.output(t)), c.push({ type_: 'hyphen' }))
                  ...
                  'frac-output': function (t, e) {
                    return { type_: 'frac-ce', p1: a.go(e[0], 'ce'), p2: a.go(e[1], 'ce') }
                  },
                  'overset-output': function (t, e) {
                    return { type_: 'overset', p1: a.go(e[0], 'ce'), p2: a.go(e[1], 'ce') }
                  },
                  'underset-output': function (t, e) {
                    return { type_: 'underset', p1: a.go(e[0], 'ce'), p2: a.go(e[1], 'ce') }
                  },
                  'underbrace-output': function (t, e) {
                    return { type_: 'underbrace', p1: a.go(e[0], 'ce'), p2: a.go(e[1], 'ce') }
                  },
                  'color-output': function (t, e) {
                    return { type_: 'color', color1: e[0], color2: a.go(e[1], 'ce') }
                  },
                  'r=': function (t, e) {
                    t.r = e
                  },
          ...
          o = {
            go: function (t, e) {
              ...
              for (var r = '', n = !1, a = 0; a < t.length; a++) {
                ...
                'string' == typeof i
                  ? (r += i)
                  : ((r += o._go2(i)), '1st-level escape' === i.type_ && (n = !0))
              }
              return e && !n && r && (r = '{' + r + '}'), r
            },
            _goInner: function (t) {
