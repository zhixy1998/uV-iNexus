              ...
              if (m.getProperty('fixPrescript')) {
                ...
                try {
                  for (var f = ((r = void 0), o([1, 2])), M = f.next(); !M.done; M = f.next()) {
                    h[(v = M.value)] ||
                      (s.default.setChild(m, v, u.nodeFactory.create('node', 'none')), p++)
                  }
                } catch (t) {
                  r = { error: t }
                } finally {
          ...
          (e.MathtoolsConfiguration = l.Configuration.create('mathtools', {
            ...
            init: function (t) {
              new i.CommandMap(e.PAIREDDELIMS, {}, {}),
                t.append(
                  l.Configuration.local({ handler: { macro: [e.PAIREDDELIMS] }, priority: -5 }),
                )
            },
            config: function (t, e) {
              var a,
            ...
            return (
              ...
              (e.prototype.EndTable = function () {
                if (
                  ...
                  i.default.getAttribute(n, 'columnalign') !== s.TexConstant.Align.RIGHT &&
                    n.appendChild(this.create('node', 'mspace', [], { width: r }))
      ...
      178: function (t, e, a) {
        ...
        e.MathtoolsMethods = {
          ...
          Cases: function (t, e, a, r, o) {
            ...
            return (
              (n.arraydef = { rowspacing: '.2em', columnspacing: '1em', columnalign: 'left' }),
          ...
          MtLap: function (t, e, a) {
            ...
            'r' !== a && m.default.setAttribute(o, 'lspace', 'l' === a ? '-1width' : '-.5width'),
              t.Push(o)
          },
          ...
          PairedDelimiters: function (t, e, a, r, n, l, s, u) {
            ...
            ;(n = n.replace(/\\delimsize/g, f)),
              (t.string = [s, h, a, n, p, r, u, t.string.substr(t.i)].reduce(function (e, a) {
          ...
          Prescript: function (t, e) {
            ...
            if (m.default.isType(a, 'none') && m.default.isType(r, 'none')) t.Push(o)
              ...
              m.default.getChildren(n).push(null, null),
                m.default.appendChildren(n, [t.create('node', 'mprescripts'), r, a]),
          ...
          setDisplayLevel: function (t, e) {
            if (e) {
              var a = r(
                ...
                n = a[1]
              null !== o &&
                (t.attributes.set('displaystyle', o), t.attributes.set('scriptlevel', n))
            }
          },
