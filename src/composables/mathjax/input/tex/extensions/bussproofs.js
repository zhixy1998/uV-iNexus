        ...
        ;(p.Inference = function (e, t, r) {
          ...
          do {
            i.length && i.unshift(e.create('node', 'mtd', [], {})),
              i.unshift(e.create('node', 'mtd', [o.Pop()], { rowalign: n ? 'top' : 'bottom' })),
              r--
          } while (r > 0)
        ...
        var l = i(r(748)),
          ...
          M = function (e, r, o, n) {
            ...
            l.default.isType(f, 'mspace')
              ...
              : ((f = e.nodeFactory.create('node', 'mspace', [], { width: u.default.Em(o) })),
          ...
          C = function (e, r, o, n, a) {
            var i = e.nodeFactory.create('node', 'mspace', [], { width: u.default.Em(a) })
            if ('left' === n) {
            ...
            for (var l = a(i), u = l.next(); !u.done; u = l.next()) {
              ...
              if (null != (0, t.getProperty)(S, 'inference')) {
                ...
                if (!d && (L = P(f))) {
                  var k = g(L)
                  if (k) {
                    var B = n.nodeFactory.create('node', 'mspace', [], { width: N - j + 'em' })
