      ...
      652: function (t, e) {
        ...
        var a = {
            ...
            concatArray: function (t, e) {
              if (e)
                if (Array.isArray(e)) for (var o = 0; o < e.length; o++) t.push(e[o])
                else t.push(e)
            },
            patterns: {
              patterns: {
            ...
            actions: {
              ...
              '1/2': function (t, e) {
                ...
                return (
                  ...
                  n[3] &&
                    ((n[3] = n[3].replace(/\$/g, '')), o.push({ type_: 'tex-math', p1: n[3] })),
                  o
                )
              },
              '9,9': function (t, e) {
              ...
              ce: {
                ...
                actions: {
                  ...
                  '- after o/d': function (t, e, o) {
                    ...
                    return (
                      c
                        ? (a.concatArray(u, this.output(t)), u.push({ type_: 'hyphen' }))
              ...
              pu: {
                ...
                actions: {
                  enumber: function (t, e) {
                    var o = []
                    return (
                      '+-' === e[0] || '+/-' === e[0] ? o.push('\\pm ') : e[0] && o.push(e[0]),
                      e[1] &&
          ...
          r = {
            go: function (t, e) {
              ...
              for (var o = '', n = !1, a = 0; a < t.length; a++) {
                ...
                'string' == typeof i
                  ? (o += i)
                  : ((o += r._go2(i)), '1st-level escape' === i.type_ && (n = !0))
              }
              return e && !n && o && (o = '{' + o + '}'), o
            },
            _goInner: function (t) {
