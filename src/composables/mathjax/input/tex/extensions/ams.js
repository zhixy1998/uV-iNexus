        ...
        e.AmsConfiguration = l.Configuration.create('ams', {
          ...
          init: function (t) {
            new m.CommandMap(u.NEW_OPS, {}, {}),
              t.append(l.Configuration.local({ handler: { macro: [u.NEW_OPS] }, priority: -1 }))
          },
          config: function (t, e) {
            ...
            (e.prototype.EndRow = function () {
              ...
              for (
                ...
                this.row.push(e),
                  ...
                  (a.length || this.padded) && this.row.push(this.create('node', 'mtd'))
      ...
      16: function (t, e, a) {
        ...
        ;(e.AmsMethods = {}),
              ...
              (i
                ? r.replaceChild(
                    t.create('node', 'mphantom', [
                      t.create('node', 'mpadded', [l.default.copyNode(d, t)], { width: 0 }),
                    ]),
          ...
          (e.AmsMethods.xArrow = function (t, e, a, r, n) {
            var i = { width: '+' + l.default.Em((r + n) / 18), lspace: l.default.Em(r / 18) },
              o = t.GetBrackets(e),
              u = t.ParseArg(e),
          ...
          (e.AmsMethods.CFrac = function (t, e) {
            var a = l.default.trimSpaces(t.GetBrackets(e, '')),
              r = t.GetArgument(e),
              n = t.GetArgument(e),
              i = { l: u.TexConstant.Align.LEFT, r: u.TexConstant.Align.RIGHT, '': '' },
              o = new m.default(
                '\\strut\\textstyle{' + r + '}',
                t.stack.env,
                t.configuration,
          ...
          (e.AmsMethods.Genfrac = function (t, e, a, r, n, i) {
            ...
            if (
              ...
              ;(m = t.create('node', 'mstyle', [m])),
                'D' === h
                  ? s.default.setProperties(m, { displaystyle: !0, scriptlevel: 0 })
                  : s.default.setProperties(m, { displaystyle: !1, scriptlevel: c - 1 })
            }
            t.Push(m)
          }),
