!(function () {
      ...
      762: function (t, e, a) {
        ...
        a(557),
          ...
          (e.TextMacrosConfiguration = r.Configuration.create('textmacros', {
            config: function (t, e) {
              var a = new r.ParserConfiguration(e.parseOptions.options.textmacros.packages, [
                'tex',
                'text',
              ])
              a.init()
            ...
            return (
              ...
              (e.prototype.Push = function (e) {
                ...
                e instanceof x.StyleItem
                  ...
                  : e instanceof m.AbstractMmlNode && (this.addAttributes(e), this.nodes.push(e))
              }),
              ...
              (e.prototype.addAttributes = function (t) {
                ...
                if (t.isToken)
                  try {
                    for (
                      var o = r(['mathsize', 'mathcolor', 'mathvariant']), s = o.next();
                      !s.done;
                      s = o.next()
                    ) {
                      var i = s.value
  ...
  ;(t = i(955)),
    ...
    (0, t.r8)({
      _: {
        input: {
          tex: { textmacros: { TextMacrosConfiguration: a, TextMacrosMethods: n, TextParser: o } },
        },
      },
    })
})()
