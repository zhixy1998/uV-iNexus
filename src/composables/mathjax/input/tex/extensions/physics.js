!(function () {
      ...
      458: function (t, e, a) {
        ...
        var P = function (t, e, a, r, n) {
          ...
          if (s) {
            ...
            if ('{' === c) {
              var u =
                (l ? '\\left\\{' : '') + ' ' + t.GetArgument(a) + ' ' + (l ? '\\right\\}' : '')
              return (t.string = u + t.string.slice(t.i)), void (t.i = 0)
            }
            l &&
              (t.i++,
              t.Push(t.itemFactory.create('auto open').setProperties({ open: c, close: s })))
          }
        }
        function A(t, e, a) {
          var n = r(t, 3),
  ...
  ;(t = c(955)),
    ...
    (0, t.r8)({
      _: {
        input: {
          tex: { physics: { PhysicsConfiguration: a, PhysicsItems: r, PhysicsMethods: n } },
        },
      },
    })
})()
