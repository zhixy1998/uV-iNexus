          ...
          d = (function (e) {
            ...
            return (
              ...
              (t.prototype.checkItem = function (t) {
                return (
                  t.isKind('end') && t.getName() === this.getName() && this.setProperty('end', !1),
          ...
          (t.EmpheqMethods = {
            Empheq: function (e, t) {
              if (e.stack.env.closing === t.getName()) {
                ...
                n && t.setProperties(c.EmpheqUtil.splitOptions(n, { left: 1, right: 1 })),
                  (e.stack.global.empheq = i),
                  (e.string =
                    '\\begin{' + i + '}' + (l ? '{' + l + '}' : '') + e.string.slice(e.i)),
                  (e.i = 0),
                  e.Push(t)
              }
            },
      ...
      301: function (e, t, a) {
        ...
        t.EmpheqUtil = {
          environment: function (e, t, a, i) {
            var o = i[0],
              l = e.itemFactory.create(o + '-begin').setProperties({ name: t, end: o })
          ...
          cellBlock: function (e, t, a, n) {
            var r,
              o,
              l = a.create('node', 'mpadded', [], { height: 0, depth: 0, voffset: '-1height' }),
              m = new p.default(e, a.stack.env, a.configuration),
              h = m.mml()
            n &&
              m.configuration.tags.label &&
              ((m.configuration.tags.currentTag.env = n), m.configuration.tags.getTag(!0))
            try {
              for (
            ...
            return (
              l.appendChild(
                a.create('node', 'mphantom', [a.create('node', 'mpadded', [t], { width: 0 })]),
              ),
              l
            )
          },
          topRowTable: function (e, t) {
            ...
            return (
              ...
              e.factory.create('mphantom', {}, [t.create('node', 'mpadded', [a], { width: 0 })])
            )
          },
          rowspanCell: function (e, t, a, n, r) {
            e.appendChild(
              n.create(
                'node',
                'mpadded',
                [this.cellBlock(t, l.default.copyNode(a, n), n, r), this.topRowTable(a, n)],
            ...
            try {
              for (
                ...
                ;(p = n.create('node', 'mtd')),
                  ...
                  (p.parent = s),
                  s.isKind('mlabeledtr') &&
                    ((s.childNodes[0] = s.childNodes[1]), (s.childNodes[1] = p))
              }
            } catch (e) {
              o = { error: e }
            } finally {
          ...
          right: function (e, a, n, r, i) {
            ...
            t.EmpheqUtil.rowspanCell(p, n, a, r, i),
              e.attributes.set(
                'columnalign',
                (e.attributes.get('columnalign') || '').split(/ /).slice(0, o).join(' ') + ' left',
              ),
              e.attributes.set(
                'columnspacing',
