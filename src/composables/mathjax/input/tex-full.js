                ...
                for (var p = n(t.data.getList('mo')), d = p.next(); !d.done; d = p.next()) {
                  ...
                  if (
                    ...
                    for (
                      ...
                      try {
                        for (
                          var b = ((l = void 0), n(m.getPropertyNames())), x = b.next();
                          !x.done;
                          x = b.next()
                        ) {
                          var _ = x.value
              ...
              try {
                for (var l = n(t.getList('m' + e + r)), c = l.next(); !c.done; c = l.next()) {
                  ...
                  if (!p[u[e]] || !p[u[r]]) {
                    var d = u.parent,
                      f = p[u[e]]
                        ? t.nodeFactory.create('node', 'm' + e, [p[u.base], p[u[e]]])
        ...
        !(function (t) {
          ...
          ;(t.matchDimen = h),
            ...
            (t.fenced = function (t, e, r, n, o, a) {
              ...
              var i,
                u = t.nodeFactory,
                p = u.create('node', 'mrow', [], { open: e, close: n, texClass: s.TEXCLASS.INNER })
              if (o) i = new c.default('\\' + o + 'l' + e, t.parser.stack.env, t).mml()
              else {
                ...
                i = u.create(
                  ...
                  'mo',
                  [],
                  { fence: !0, stretchy: !0, symmetric: !0, texClass: s.TEXCLASS.OPEN },
                  d,
                )
              }
              if ((l.default.appendChildren(p, [i, r]), o))
                ...
                i = u.create(
                  ...
                  'mo',
                  [],
                  { fence: !0, stretchy: !0, symmetric: !0, texClass: s.TEXCLASS.CLOSE },
                  f,
                )
              }
                ...
                if (
                  ...
                  (!l.default.isType(o, 'TeXAtom') ||
                    (l.default.getChildren(o)[0] &&
                      l.default.getChildren(l.default.getChildren(o)[0]).length))
                ) {
                  if (
                    l.default.isEmbellished(o) ||
                    (l.default.isType(o, 'TeXAtom') && l.default.getTexClass(o) === s.TEXCLASS.REL)
                  ) {
                  ...
                  if ('$' === (o = e.charAt(p++)))
                    '$' === f && 0 === h
                      ? ((a = t.create('node', 'TeXAtom', [
                        ...
                        (d = p))
                      : '' === f &&
                        (d < p - 1 && l.push(y(t, e.slice(d, p - 1), s)), (f = '$'), (d = p))
                  else if ('{' === o && '' !== f) h++
                  else if ('}' === o)
                    if ('}' === f && 0 === h) {
            ...
            (t.checkMaxMacros = function (t, e) {
              if (
                (void 0 === e && (e = !0), !(++t.macroCount <= t.configuration.options.maxMacros))
              )
                throw e
                  ? new u.default(
                      'MaxMacroSub1',
      ...
      7044: function (t, e, r) {
        ...
        var p = (function (t) {
          function e(e) {
            ...
            return (
              (o.factory = e), (o.global = {}), (o._properties = {}), o.isOpen && (o._env = {}), o
            )
          }
          return (
            o(e, t),
        ...
        var u = (function () {
          ...
          return (
            ...
            (t.prototype.makeTag = function () {
              this.makeId(),
                this.label &&
                  (this.labels[this.label] = new l(this.currentTag.tag, this.currentTag.tagId))
              var t = new s.default(
          ...
          p = (function () {
            ...
            return (
              ...
              (t.prototype.toString = function () {
                ...
                try {
                  for (
                    var o = n(Array.from(this.configuration.handlers.keys())), a = o.next();
                    !a.done;
                    a = o.next()
                  ) {
                    var i = a.value
              ...
              (a
                ? n.replaceChild(
                    t.create('node', 'mphantom', [
                      t.create('node', 'mpadded', [i.default.copyNode(p, t)], { width: 0 }),
                    ]),
            ...
            if (
              ...
              ;(u = t.create('node', 'mstyle', [u])),
                'D' === f
                  ...
                  : l.default.setProperties(u, { displaystyle: !1, scriptlevel: d - 1 })
            }
            t.Push(u)
          }),
        ...
        var o = n(r(810)),
          ...
          l = {
            ...
            arrow: function (t, e) {
              ...
              for (
                var c, u = n, p = u.table.length % 2 == 1, d = (u.row.length + (p ? 0 : 1)) % 2;
                d;
      ...
      1451: function (t, e, r) {
        ...
        function p(t, e, r, a) {
          ...
          if (c.Package.packages.has(t.options.require.prefix + r)) {
            ...
            ;(t.string = (a ? e + ' ' : '\\begin{' + e.slice(1) + '}') + t.string.slice(t.i)),
              (t.i = 0)
          }
          ;(0, l.RequireLoad)(t, r)
        }
                      ...
                      if (i.attributes.get('scriptlevel') > 0) {
                        ...
                        if (
                          ...
                          n.removeFromList('mstyle', [l]),
                            n.removeFromList('mspace', l.childNodes[0].childNodes)
                        }
                      } else
                        i.isKind('mrow') &&
                          (i.parent.replaceChild(i.childNodes[0], i), n.removeFromList('mrow', [i]))
                    }
                  } catch (t) {
                    e = { error: t }
                  } finally {
        ...
        var I = (function (t) {
          ...
          return (
            ...
            (e.prototype.checkItem = function (t) {
              ...
              return [
                [(e = this.create('node', 'TeXAtom', [a], { texClass: u.TEXCLASS.REL })), t],
                !0,
              ]
            }),
            e
          ...
          return (
            ...
            (e.prototype.addRowSpacing = function (t) {
              if (this.arraydef.rowspacing) {
                ...
                ;(e[this.table.length - 1] = d.default.Em(Math.max(0, n + d.default.dimen2em(t)))),
                  (this.arraydef.rowspacing = e.join(' '))
              }
            }),
            e
      ...
      724: function (t, e, r) {
        ...
        ;(x.Open = function (t, e) {
          ...
          (x.SetSize = function (t, e, r) {
            ;(t.stack.env.size = r),
              t.Push(
                t.itemFactory.create('style').setProperty('styles', { mathsize: (0, y.em)(r) }),
              )
          }),
          ...
          (x.Sqrt = function (t, e) {
            ...
            ;(o = r ? t.create('node', 'mroot', [o, M(t, r)]) : t.create('node', 'msqrt', [o])),
              t.Push(o)
          }),
          (x.Root = function (t, e) {
          ...
          (x.Overunderset = function (t, e) {
            ...
            var a = t.create('node', 'munderover', [o, n, r], { accent: !1, accentunder: !1 })
            t.Push(a)
          }),
          ...
          (x.Entry = function (t, e) {
            ...
            if (r.getProperty('isCases') || n) {
              for (
                ...
                var u = o.charAt(s)
                if ('{' === u) a++, s++
                else if ('}' === u) 0 === a ? (l = 0) : (0 === --a && i < 0 && (i = s - t.i), s++)
                else {
                  if ('&' === u && 0 === a)
          ...
          (x.Array = function (t, e, r, n, o, a, i, s, l) {
            ...
            return (
              (u.arraydef = { columnalign: o, columnspacing: a || '1em', rowspacing: i || '4pt' }),
              c.match(/[|:]/) &&
                (c.charAt(0).match(/[|:]/) &&
            ...
            return (
              ...
              (e.prototype.checkItem = function (e) {
                return e.isKind('close')
                  ...
                  : e.isKind('mml')
                    ? (this.Push(e.toMml()),
                      this.getProperty('single') ? [[this.toMml()], !0] : i.BaseItem.fail)
      ...
      3583: function (t, e, r) {
        ...
        function g(t, e) {
          ...
          var n = i(r.split('\\fCenter'), 2),
            ...
            y = t.create('node', 'mtable', [g], { columnspacing: '.5ex', columnalign: 'center 2' })
            ...
            for (var s = a(i), l = s.next(); !l.done; l = s.next()) {
              ...
              if (null != (0, e.getProperty)(T, 'inference')) {
                ...
                if (!p && (N = v(c))) {
                  var q = b(N)
                  if (q) {
                    var L = o.nodeFactory.create('node', 'mspace', [], { width: k - E + 'em' })
        ...
        function u(t) {
          ...
          try {
            for (var a = n(o.getList('centerOver')), i = a.next(); !i.done; i = a.next()) {
              ...
              null !== c &&
                s.default.setProperties(l.parent.parent.parent.parent.parent.parent, {
                  texClass: c,
                })
            }
          } catch (t) {
              ...
              var r = '{' + t.GetArgument(e) + '}',
                ...
                a = t.create('node', 'TeXAtom', [
                  ...
                  t.create(
                    ...
                    'mpadded',
                    [
                      t.create('node', 'mpadded', [n], { width: 0, lspace: '-.5width' }),
            ...
            },
            {
              TableColor: function (t, e, r) {
                var n = t.configuration.packageData.get('color').model,
                  ...
                  i = t.stack.Top()
                if (!(i instanceof u))
                  throw new c.default('UnsupportedTableColor', 'Unsupported use of %1', t.currentCS)
                if ('col' === r) {
                  if (i.table.length)
        ...
        e.ConfigMacrosConfiguration = i.Configuration.create('configmacros', {
          init: function (t) {
            new l.CommandMap(f, {}, {}),
              ...
              t.append(
                i.Configuration.local({ handler: { macro: [f], environment: [h] }, priority: 3 }),
              )
          },
          config: function (t, e) {
            !(function (t) {
              ...
              try {
                for (var i = o(Object.keys(a)), s = i.next(); !s.done; s = i.next()) {
                  var l = s.value,
                    ...
                    d = Array.isArray(c[2])
                      ? new u.Macro(l, p.default.MacroWithTemplate, c.slice(0, 2).concat(c[2]))
        ...
        var l = r(6552),
          ...
          h = (function (t) {
            ...
            return (
              ...
              (e.prototype.checkItem = function (e) {
                return (
                  e.isKind('end') && e.getName() === this.getName() && this.setProperty('end', !1),
                  t.prototype.checkItem.call(this, e)
                )
              }),
              e
            ...
            Empheq: function (t, e) {
              if (t.stack.env.closing === e.getName()) {
                ...
                f.EmpheqUtil.adjustTable(r, t),
                  t.Push(t.itemFactory.create('end').setProperty('name', 'empheq'))
              } else {
                ...
                n && e.setProperties(f.EmpheqUtil.splitOptions(n, { left: 1, right: 1 })),
                  ...
                  (t.string =
                    '\\begin{' + a + '}' + (s ? '{' + s + '}' : '') + t.string.slice(t.i)),
                  (t.i = 0),
                  t.Push(e)
              }
            },
        ...
        e.EmpheqUtil = {
          ...
          cellBlock: function (t, e, r, n) {
            ...
            n &&
              ...
              ((c.configuration.tags.currentTag.env = n), c.configuration.tags.getTag(!0))
            try {
              for (
            ...
            return (
              s.appendChild(
                r.create('node', 'mphantom', [r.create('node', 'mpadded', [e], { width: 0 })]),
              ),
              s
            )
          },
          ...
          rowspanCell: function (t, e, r, n, o) {
            t.appendChild(
              n.create(
                'node',
                'mpadded',
                [this.cellBlock(e, s.default.copyNode(r, n), n, o), this.topRowTable(r, n)],
            ...
            try {
              for (
                ...
                ;(l = n.create('node', 'mtd')),
                  ...
                  (l.parent = p),
                  p.isKind('mlabeledtr') &&
                    ((p.childNodes[0] = p.childNodes[1]), (p.childNodes[1] = l))
              }
            } catch (t) {
              i = { error: t }
            } finally {
          ...
          right: function (t, r, n, o, a) {
            ...
            e.EmpheqUtil.rowspanCell(l, n, r, o, a),
              t.attributes.set(
                'columnalign',
                (t.attributes.get('columnalign') || '').split(/ /).slice(0, i).join(' ') + ' left',
              ),
              t.attributes.set(
                'columnspacing',
              ...
              if (d.getProperty('fixPrescript')) {
                ...
                try {
                  for (var m = ((n = void 0), o([1, 2])), g = m.next(); !g.done; g = m.next()) {
                    f[(b = g.value)] ||
                      (l.default.setChild(d, b, c.nodeFactory.create('node', 'none')), h++)
                  }
                } catch (t) {
                  n = { error: t }
                } finally {
          ...
          (e.MathtoolsConfiguration = i.Configuration.create('mathtools', {
            ...
            init: function (t) {
              new s.CommandMap(e.PAIREDDELIMS, {}, {}),
                t.append(
                  i.Configuration.local({ handler: { macro: [e.PAIREDDELIMS] }, priority: -5 }),
                )
            },
            config: function (t, e) {
              var r,
      ...
      8155: function (t, e, r) {
        ...
        e.MathtoolsMethods = {
          ...
          MtLap: function (t, e, r) {
            ...
            'r' !== r && d.default.setAttribute(o, 'lspace', 'l' === r ? '-1width' : '-.5width'),
              t.Push(o)
          },
          ...
          PairedDelimiters: function (t, e, r, n, a, i, l, c) {
            ...
            ;(a = a.replace(/\\delimsize/g, m)),
              (t.string = [l, f, r, a, h, n, c, t.string.substr(t.i)].reduce(function (e, r) {
          ...
          Prescript: function (t, e) {
            ...
            if (d.default.isType(r, 'none') && d.default.isType(n, 'none')) t.Push(o)
              ...
              d.default.getChildren(a).push(null, null),
                d.default.appendChildren(a, [t.create('node', 'mprescripts'), n, r]),
          ...
          setDisplayLevel: function (t, e) {
            if (e) {
              var r = n(
                ...
                a = r[1]
              null !== o &&
                (t.attributes.set('displaystyle', o), t.attributes.set('scriptlevel', a))
            }
          },
      ...
      1541: function (t, e, r) {
        ...
        var M = function (t, e, r, n, o) {
          ...
          if (l) {
            ...
            if ('{' === s) {
              var u =
                (c ? '\\left\\{' : '') + ' ' + t.GetArgument(r) + ' ' + (c ? '\\right\\}' : '')
              return (t.string = u + t.string.slice(t.i)), void (t.i = 0)
            }
            c &&
              (t.i++,
              t.Push(t.itemFactory.create('auto open').setProperties({ open: s, close: l })))
          }
        }
        function w(t, e, r) {
          var o = n(t, 3),
        ...
        ;(e.RequireLoad = y),
          ...
          (e.RequireConfiguration = s.Configuration.create('require', {
            ...
            config: function (t, e) {
              ...
              d.CONFIG.paths[n] || (d.CONFIG.paths[n] = '[mathjax]/input/tex/extensions'),
                (r.prefix = '[' + n + ']/')
            },
            options: e.options,
          }))
                ...
                try {
                  for (var c = n(Object.keys(i)), u = c.next(); !u.done; u = c.next()) {
                    ...
                    s.filterOption(t, a, p) &&
                      (('tex' === a ? t.options : t.options[a])[p] = s.filterValue(t, a, p, i[p]))
                  }
                } catch (t) {
                  r = { error: t }
                } finally {
      ...
      82: function (t, e, r) {
        ...
        r(7900),
          ...
          (e.TextMacrosConfiguration = a.Configuration.create('textmacros', {
            config: function (t, e) {
              var r = new a.ParserConfiguration(e.parseOptions.options.textmacros.packages, [
                'tex',
                'text',
              ])
              r.init()
            ...
            return (
              ...
              (e.prototype.saveText = function () {
                if (this.text) {
                  var t = this.stack.env.mathvariant,
                    e = p.default.internalText(this, this.text, t ? { mathvariant: t } : {})
              ...
              (e.prototype.addAttributes = function (t) {
                ...
                if (t.isToken)
                  try {
                    for (
                      var o = a(['mathsize', 'mathcolor', 'mathvariant']), i = o.next();
                      !i.done;
                      i = o.next()
                    ) {
                      var s = i.value
      ...
      4325: function (t, e, r) {
        ...
        ;(e.VerbMethods = {}),
          (e.VerbMethods.Verb = function (t, e) {
            ...
            t.i++,
              t.Push(
                t.create('token', 'mtext', { mathvariant: a.TexConstant.Variant.MONOSPACE }, o),
              )
          }),
                    ...
                    for (var d = c[u].task, f = 0; f < d.action_.length; f++) {
                      ...
                      if (l.actions[d.action_[f].type_])
                        ...
                        if (!o.actions[d.action_[f].type_])
                          throw [
                            'MhchemBugA',
                            'mhchem bug A. Please report. (' + d.action_[f].type_ + ')',
                          ]
            ...
            actions: {
              ...
              '1/2': function (t, e) {
                ...
                return (
                  ...
                  n[3] &&
                    ((n[3] = n[3].replace(/\$/g, '')), r.push({ type_: 'tex-math', p1: n[3] })),
                  r
                )
              },
              '9,9': function (t, e) {
        ...
        _: {
          input: {
            ...
            tex: {
              ...
              color: { ColorConfiguration: H, ColorConstants: K, ColorMethods: J, ColorUtil: W },
              ...
              physics: { PhysicsConfiguration: yt, PhysicsItems: vt, PhysicsMethods: bt },
              ...
              textmacros: { TextMacrosConfiguration: At, TextMacrosMethods: Ct, TextParser: Pt },
