                ...
                try {
                  for (
                    ...
                    if ('xmlns:' === p.name.substr(0, 6) && p.value === s) {
                      ...
                      try {
                        for (
                          var d = ((o = void 0), i(this.adaptor.tags(t, u + ':math'))),
                            f = d.next();
                          !f.done;
                          f = d.next()
                        ) {
                ...
                try {
                  for (var o = i(Array.from(t)), n = o.next(); !n.done; n = o.next()) {
                    var s = n.value,
                      ...
                      c = { node: s, n: 0, delim: '' },
                      h = { node: s, n: 0, delim: '' }
                    a.push({ math: this.adaptor.outerHTML(s), start: c, end: h, display: l })
                  }
                } catch (t) {
                  e = { error: t }
                } finally {
          ...
          p = (function () {
            ...
            return (
              ...
              (t.prototype.makeNode = function (t) {
                ...
                try {
                  for (
                    var h = s(this.filterClassList(a.allClasses(t))), p = h.next();
                    !p.done;
                    p = h.next()
                  ) {
                    var u = p.value
                    ...
                    if (null !== h && 'xmlns' !== c)
                      if ('data-mjx-' === c.substr(0, 9))
                        ...
                        'true' === p || 'false' === p
                          ...
                          : (o && 'mathvariant' === c) || t.attributes.set(c, h)
                      }
                  }
                } catch (t) {
                  r = { error: t }
                        ...
                        if ('#text' === c) this.addText(t, l)
                          ...
                          0 === h.arity &&
                            ...
                            (this.options.fixMisplacedChildren
                              ...
                              : h.mError(
                                  'There should not be children for ' + h.kind + ' nodes',
                                  this.options.verify,
                                  !0,
                                ))
                        }
              ...
              (t.prototype.checkClass = function (t, e) {
                ...
                try {
                  for (
                    var i = s(this.filterClassList(this.adaptor.allClasses(e))), n = i.next();
                    !n.done;
                    n = i.next()
                  ) {
                    var l = n.value
