                ...
                for (var f = n(t.data.getList('mo')), d = f.next(); !d.done; d = f.next()) {
                  ...
                  if (
                    ...
                    for (
                      ...
                      try {
                        for (
                          var b = ((l = void 0), n(m.getPropertyNames())), A = b.next();
                          !A.done;
                          A = b.next()
                        ) {
                          var M = A.value
              ...
              try {
                for (var l = n(t.getList('m' + e + r)), u = l.next(); !u.done; u = l.next()) {
                  ...
                  if (!f[c[e]] || !f[c[r]]) {
                    var d = c.parent,
                      h = f[c[e]]
                        ? t.nodeFactory.create('node', 'm' + e, [f[c.base], f[c[e]]])
        ...
        !(function (t) {
          ...
          ;(t.matchDimen = p),
            ...
            (t.fenced = function (t, e, r, n, a, o) {
              ...
              if (a) i = new u.default('\\' + a + 'l' + e, t.parser.stack.env, t).mml()
              else {
                ...
                if (
                  ...
                  (!l.default.isType(a, 'TeXAtom') ||
                    (l.default.getChildren(a)[0] &&
                      l.default.getChildren(l.default.getChildren(a)[0]).length))
                ) {
                  if (
                    l.default.isEmbellished(a) ||
                    (l.default.isType(a, 'TeXAtom') && l.default.getTexClass(a) === s.TEXCLASS.REL)
                  ) {
                  ...
                  if ('$' === (a = e.charAt(f++)))
                    '$' === h && 0 === p
                      ? ((o = t.create('node', 'TeXAtom', [
                        ...
                        (d = f))
                      : '' === h &&
                        (d < f - 1 && l.push(y(t, e.slice(d, f - 1), s)), (h = '$'), (d = f))
                  else if ('{' === a && '' !== h) p++
                  else if ('}' === a)
                    if ('}' === h && 0 === p) {
        ...
        e.AmsConfiguration = i.Configuration.create('ams', {
          ...
          init: function (t) {
            new c.CommandMap(u.NEW_OPS, {}, {}),
              t.append(i.Configuration.local({ handler: { macro: [u.NEW_OPS] }, priority: -1 }))
          },
          config: function (t, e) {
        ...
        ;(e.AmsMethods = {}),
              ...
              (o
                ? n.replaceChild(
                    t.create('node', 'mphantom', [
                      t.create('node', 'mpadded', [i.default.copyNode(f, t)], { width: 0 }),
                    ]),
          ...
          (e.AmsMethods.CFrac = function (t, e) {
            var r = i.default.trimSpaces(t.GetBrackets(e, '')),
              n = t.GetArgument(e),
              a = t.GetArgument(e),
              o = { l: u.TexConstant.Align.LEFT, r: u.TexConstant.Align.RIGHT, '': '' },
              s = new c.default(
                '\\strut\\textstyle{' + n + '}',
                t.stack.env,
                t.configuration,
          ...
          (e.AmsMethods.Genfrac = function (t, e, r, n, a, o) {
            ...
            if (
              ...
              ;(c = t.create('node', 'mstyle', [c])),
                'D' === h
                  ? l.default.setProperties(c, { displaystyle: !0, scriptlevel: 0 })
                  : l.default.setProperties(c, { displaystyle: !1, scriptlevel: d - 1 })
            }
            t.Push(c)
          }),
              ...
              if (e.isKind('mml')) {
                ...
                return (
                  ...
                  null != this.getProperty('movesupsub') &&
                    h.default.setProperty(r, 'movesupsub', this.getProperty('movesupsub')),
                  [[this.factory.create('mml', r)], !0]
                )
              }
              ...
              if (e.isClose) {
                ...
                return (
                  null != this.getProperty('thickness') &&
                    h.default.setAttribute(r, 'linethickness', this.getProperty('thickness')),
                ...
                if (!e.isKind('fn')) {
                  ...
                  if (
                    (h.default.isType(n, 'mstyle') &&
                      n.childNodes.length &&
                      h.default.isType(n.childNodes[0].childNodes[0], 'mspace')) ||
        ...
        var I = (function (t) {
          ...
          return (
            ...
            (e.prototype.checkItem = function (t) {
              ...
              return [
                [(e = this.create('node', 'TeXAtom', [o], { texClass: c.TEXCLASS.REL })), t],
                !0,
              ]
            }),
            e
      ...
      724: function (t, e, r) {
        ...
        ;(A.Open = function (t, e) {
          ...
          (A.Sqrt = function (t, e) {
            ...
            ;(a = r ? t.create('node', 'mroot', [a, x(t, r)]) : t.create('node', 'msqrt', [a])),
              t.Push(a)
          }),
          (A.Root = function (t, e) {
        ...
        e.ConfigMacrosConfiguration = i.Configuration.create('configmacros', {
          init: function (t) {
            new l.CommandMap(h, {}, {}),
              ...
              t.append(
                i.Configuration.local({ handler: { macro: [h], environment: [p] }, priority: 3 }),
              )
          },
          config: function (t, e) {
            !(function (t) {
