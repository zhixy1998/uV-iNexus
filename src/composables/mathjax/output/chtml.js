!(function () {
          ...
          v = (function (t) {
            ...
            return (
              ...
              (e.prototype.styleSheet = function (r) {
                ...
                return (
                  this.adaptor.setAttribute(n, 'id', e.STYLESHEETID), this.wrapperUsage.update(), n
                )
              }),
        ...
        var d = (function (t) {
          ...
          return (
            ...
            (e.prototype.allStyles = function (t) {
              ...
              try {
                for (var p = l(Object.keys(this.variant)), d = p.next(); !d.done; d = p.next()) {
                  ...
                  try {
                    for (
                      var v = ((i = void 0), l(Object.keys(m.chars))), b = v.next();
                      !b.done;
                      b = v.next()
                    ) {
                      ...
                      var g = m.chars[u]
                      ;(g[3] || {}).smp ||
                        (g.length < 4 && (g[3] = {}), this.addCharStyles(t, y, u, g))
                    }
                  } catch (t) {
                    i = { error: t }
                  } finally {
            ...
            (e.prototype.addDelimiterStyles = function (t, e, r) {
              ...
              r.c &&
                r.c !== e &&
                (t['.mjx-stretched mjx-c' + (o = this.charSelector(r.c)) + '::before'] = {
            ...
            (e.prototype.addDelimiterVPart = function (t, e, r, o, n) {
              ...
              return (
                'ext' !== r
                  ...
                  : ((s.width = this.em0(n[2])), a && (s['padding-left'] = this.em0(a))),
            ...
            (e.prototype.addDelimiterHPart = function (t, e, r, o, n) {
              if (o) {
                var i = this.getDelimiterData(o)[3],
                  a = { content: i && i.c ? '"' + i.c + '"' : this.charContent(o) }
            ...
            (r.prototype.drawBBox = function () {
              var t = this.getBBox(),
                ...
                i = this.html(
                  ...
                  [
                    this.html('mjx-box', {
                      style: { height: this.em(r), width: this.em(e), 'background-color': 'red' },
                    }),
                    this.html('mjx-box', {
                      style: {
                        height: this.em(o),
                  ...
                  this.html('mjx-frac', c, [
                    ...
                    this.html('mjx-dbox', {}, [
                      this.html('mjx-dtable', {}, [
                        ...
                        this.html('mjx-row', {}, [
                          (o = this.html('mjx-den', u, [this.html('mjx-dstrut', p)])),
                        ]),
                      ]),
                    ]),
                  ]),
              ...
              (e.prototype.toCHTML = function (t) {
                ...
                if (
                  ...
                  var y = this.html('mjx-rbox', {
                    style: { left: this.em(d + m), top: this.em(-f), 'max-width': s.width },
                  })
                  d + m &&
              ...
              (e.prototype.toCHTML = function (t) {
                ...
                var f = this.adaptor.append(
                  ...
                  this.html('mjx-sqrt', {}, [
                    ...
                    (r = this.html('mjx-box', { style: { paddingTop: this.em(h) } })),
                  ]),
                )
        ...
        var d = (function (t) {
          ...
          return (
            ...
            (e.prototype.toCHTML = function (t) {
              ...
              a.toCHTML(p),
                e.append(p, this.html('mjx-spacer', { style: { 'margin-top': this.em(h) } })),
                s.toCHTML(p)
          ...
          u = (function (t) {
            ...
            return (
                ...
                if ('none' !== this.node.attributes.get('columnlines')) {
                  ...
                  try {
                    for (var a = i(this.childNodes), s = a.next(); !s.done; s = a.next()) {
                      ...
                      try {
                        for (
                          var h = ((r = void 0), i(this.adaptor.childNodes(l.chtml).slice(1))),
                            u = h.next();
                          !u.done;
                          u = h.next()
                        ) {
              ...
              (e.prototype.handleColumnWidths = function () {
                ...
                try {
                  for (var n = i(this.childNodes), a = n.next(); !a.done; a = n.next()) {
                    ...
                    try {
                      for (
                        var c = ((r = void 0), i(this.adaptor.childNodes(s.chtml))), h = c.next();
                        !h.done;
                        h = c.next()
                      ) {
                        var u = h.value,
                  ...
                  try {
                    for (var s = i(this.childNodes.slice(1)), l = s.next(); !l.done; l = s.next()) {
                      ...
                      if ('none' !== h)
                        try {
                          for (
                            var u = ((r = void 0), i(this.adaptor.childNodes(c.chtml))),
                              p = u.next();
                            !p.done;
                            p = u.next()
                          ) {
              ...
              (e.prototype.addLabelPadding = function (t) {
                ...
                return (
                  this.adaptor.append(this.chtml, this.html('mjx-labels', n, [this.labels])), [r, o]
                )
              }),
      ...
      7795: function (t, e, r) {
        ...
        var u = (function (t) {
          ...
          return (
            ...
            (e.styles = {
              'mjx-annotation-xml': { 'font-family': 'initial', 'line-height': 'normal' },
            }),
            e
          )
        })(i.CHTMLWrapper)
        ...
        var x = (function (t) {
          ...
          return (
            ...
            (e.prototype.getStyles = function () {
              ...
              if (t)
                for (
                  var r = (this.styles = new m.Styles(t)), o = 0, n = e.removeStyles.length;
                  o < n;
                  o++
                ) {
                          ...
                          if (v.value >= p)
                            return (
                              ...
                              void (
                                d.schar &&
                                d.schar[m] &&
                                (this.stretch = a(a({}, this.stretch), { c: d.schar[m] }))
                              )
                            )
                          m++
                        }
                ...
                (e.prototype.getDeltaW = function (t, e) {
                  ...
                  try {
                    for (var f = s(h.keys()), m = f.next(); !m.done; m = f.next()) {
                      var y = m.value
                      ;(p[y] =
                        ('center' === c ? (u - h[y]) / 2 : 'right' === c ? u - h[y] : 0) + e[y]),
                        p[y] < d && (d = -p[y])
                    }
                  } catch (t) {
                    r = { error: t }
  ...
  ;(ft.n = function (t) {
    ...
    MathJax.startup &&
      (MathJax.startup.registerConstructor('chtml', r.CHTML), MathJax.startup.useOutput('chtml'))
})()
