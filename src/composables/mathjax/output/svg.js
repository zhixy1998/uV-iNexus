      ...
      9250: function (t, e, r) {
        ...
        var l = (function () {
          function t(t) {
            ...
            ;(this.options = (0, s.userOptions)((0, s.defaultOptions)({}, h.OPTIONS), t)),
          ...
          return (
            ...
            (t.prototype.createVariant = function (t, e, r) {
              ...
              var o = { linked: [], chars: e ? Object.create(this.variant[e].chars) : {} }
              r &&
                this.variant[r] &&
              ...
              o + 'arrow',
              {
                ...
                bbox: function (t) {
                  var e = t.arrowData(),
                    ...
                    f =
                      n +
                      (u > Math.PI / 2 - o ? t.thickness * p * Math.sin(u + o - Math.PI / 2) : 0)
                  return [d, f, d, f]
                },
                remove: n[3],
              },
          ...
          f = (function (t) {
            ...
            return (
              ...
              (e.prototype.html = function (t, e, r, o) {
                return (
                  void 0 === e && (e = {}), void 0 === r && (r = []), this.adaptor.node(t, e, r, o)
                )
              }),
        ...
        var x = (function (t) {
          ...
          return (
            ...
            (e.prototype.getStyles = function () {
              ...
              if (t)
                for (
                  var r = (this.styles = new y.Styles(t)), o = 0, n = e.removeStyles.length;
                  o < n;
                  o++
                ) {
            ...
            (e.prototype.isTopEmbellished = function () {
              return (
                this.node.isEmbellished && !(this.node.parent && this.node.parent.isEmbellished)
              )
            }),
          ...
          return (function (t) {
            ...
            return (
              ...
              (e.prototype.getNotations = function () {
                ...
                try {
                  for (
                    var o = h((0, p.split)(this.node.attributes.get('notation'))), n = o.next();
                    !n.done;
                    n = o.next()
                  ) {
                    var i = n.value,
                          ...
                          if (v.value >= p)
                            return (
                              ...
                              void (
                                d.schar &&
                                d.schar[y] &&
                                (this.stretch = a(a({}, this.stretch), { c: d.schar[y] }))
                              )
                            )
                          y++
                        }
        ...
        e.CommonMsqrtMixin = function (t) {
          return (function (t) {
            function e() {
              ...
              return (
                (o.surdH = l + c + 2 * h + u / 4), n.getStretchedVariant([o.surdH - c, c], !0), o
              )
            }
            return (
              n(e, t),
              ...
              (e = (function (t) {
                ...
                return (
                  ...
                  (e.prototype.getUVQ = function (t, e) {
                    ...
                    return (
                      (c = Math.max(
                        this.length2em(this.node.attributes.get('superscriptshift'), c),
                        c,
                      )),
                      (h = Math.max(
          ...
          return (function (t) {
            function e() {
              ...
              ;(o.numCols = 0),
                ...
                o.findContainer(),
                (o.isTop =
                  !o.container || (o.container.node.isKind('math') && !o.container.parent)),
            ...
            return (
              ...
              (e.prototype.getTableData = function () {
                ...
                for (
                  ...
                  for (
                    var l = 0, c = a[s], h = c.node.attributes.get('rowalign'), u = 0;
                    u < c.numCells;
                    u++
                  ) {
                    var p = c.getChild(u)
                  ...
                  ;(o[s] = t[s]),
                    (n[s] = e[s]),
                    c.labeled && (l = this.updateHDW(c.childNodes[0], 0, s, h, t, e, i, l)),
              ...
              (e.prototype.computeBBox = function (t, e) {
                ...
                o =
                  (0, h.sum)(u.concat(this.cLines, this.cSpace)) + 2 * (this.fLine + this.fSpace[0])
              ...
              (e.prototype.getPadAlignShift = function (t) {
                ...
                var a = i(this.getAlignShift(), 2),
                  ...
                  l = a[1]
                return (
                  s === t && (l = 'left' === t ? Math.max(e, l) - e : Math.min(-e, l) + e),
                  [e, s, l]
                )
              }),
              (e.prototype.getAlignShift = function () {
              ...
              (e.prototype.getAlignmentRow = function () {
                ...
                var o = parseInt(r)
                return (
                  o < 0 && (o += this.numRows + 1), [e, o < 1 || o > this.numRows ? null : o - 1]
                )
              }),
              ...
              return (
                ...
                (e.prototype.computeBBox = function (e) {
                  if (this.hasMovableLimits()) t.prototype.computeBBox.call(this, e)
                    ...
                    this.node.attributes.get('accent') &&
                      (o.h = Math.max(o.h, this.font.params.x_height * o.scale))
              ...
              function e() {
                ...
                return n
                  ? (o.setBaseAccentsFor(n),
                    ...
                    o.checkLineAccents(),
                    (o.baseRemoveIc =
                      !o.isLineAbove && !o.isLineBelow && (!o.constructor.useIC || o.isMathAccent)),
                    o)
                  : o
              }
              return (
                ...
                (e.prototype.getOverKU = function (t, e) {
                  var r = this.node.attributes.get('accent'),
                    ...
                    l =
                      (r ? s : Math.max(o.big_op_spacing1, o.big_op_spacing3 - Math.max(0, n))) - a
                ...
                (e.prototype.getDeltaW = function (t, e) {
                  ...
                  try {
                    for (var f = s(h.keys()), y = f.next(); !y.done; y = f.next()) {
                      var m = y.value
                      ;(p[m] =
                        ('center' === c ? (u - h[m]) / 2 : 'right' === c ? u - h[m] : 0) + e[m]),
                        p[m] < d && (d = -p[m])
                    }
                  } catch (t) {
                    r = { error: t }
        ...
        var d = (function (t) {
          ...
          return (
            ...
            (r.prototype.findCache = function (t) {
              for (
                var e = this.adaptor, o = e.tags(e.body(t.document), 'svg'), n = o.length - 1;
                n >= 0;
                n--
              )
                if (this.adaptor.getAttribute(o[n], 'id') === r.FONTCACHEID) return !0
              return !1
            }),
            ...
            (r.prototype.createRoot = function (t) {
              ...
              return (
                'none' !== this.options.fontCache && u.setAttribute(p, 'xmlns:xlink', e.XLINKNS),
                [p, h]
              )
            }),
      ...
      9708: function (t, e, r) {
        ...
        var h = (function (t) {
          ...
          return (
            ...
            (e.OPTIONS = i(i({}, c.FontData.OPTIONS), { dynamicPrefix: './output/svg/fonts' })),
            (e.JAX = 'SVG'),
            e
          )
        })(c.FontData)
            ...
            return (
              ...
              (e.prototype.handleAttributes = function () {
                ...
                try {
                  for (var c = i(a.getExplicitNames()), h = c.next(); !h.done; h = c.next()) {
                    var u = h.value
                    ;(!1 !== l[u] &&
                      (u in s || l[u] || this.adaptor.hasAttribute(this.element, u))) ||
              ...
              (e.prototype.firstChild = function () {
                ...
                return (
                  ...
                  e && 'rect' === t.kind(e) && t.getAttribute(e, 'data-hitbox') && (e = t.next(e)),
                  e
                )
              }),
              ...
              (e.prototype.drawBBox = function () {
                var t = this.getBBox(),
                  ...
                  n = this.svg('g', { style: { opacity: 0.25 } }, [
                    this.svg('rect', { fill: 'red', height: this.fixed(r), width: this.fixed(e) }),
                    this.svg('rect', {
                      fill: 'green',
                      height: this.fixed(o),
                      width: this.fixed(e),
                      ...
                      if (r) {
                        ...
                        if (r.node.isKind('mtext')) {
                          ...
                          var i = t.adaptor,
                            ...
                            c = i.append(
                              o,
                              t.svg('foreignObject', { style: { display: 'none' } }, [l]),
                            )
            ...
            return (
              ...
              (e.prototype.handleDisplay = function () {
                var t = i(this.getAlignShift(), 2),
                  ...
                  r = t[1]
                if (
                  ('center' !== e && this.adaptor.setAttribute(this.jax.container, 'justify', e),
              ...
              (e.prototype.setChildPWidths = function (e, r, o) {
                return (
                  ...
                  t.prototype.setChildPWidths.call(
                    this,
                    e,
                    this.parent ? r : this.metrics.containerWidth / this.jax.pxPerEm,
                    !1,
                  )
                )
              }),
          ...
          s = (function (t) {
            ...
            return (
              ...
              (e.prototype.toSVG = function (t) {
                ...
                a &&
                  this.adaptor.append(this.element, this.svg('title', {}, [this.adaptor.text(a)])),
                  this.addChildren(e)
              }),
          ...
          return (
            ...
            (e.prototype.toSVG = function (t) {
              var e = this.standardSVGnode(t),
                ...
                f = 0
              r.numPrescripts &&
                (f = this.addScripts(0.05, p, d, this.firstPrescript, r.numPrescripts, a))
          ...
          h = (function (t) {
            function e(e, r, o) {
              ...
              var n = t.call(this, e, r, o) || this,
                i = { 'data-labels': !0 }
              return (
                n.isTop && (i.transform = 'matrix(1 0 0 -1 0 0)'), (n.labels = n.svg('g', i)), n
              )
            }
            return (
              n(e, t),
              ...
              (e.prototype.handlePWidth = function (t) {
                ...
                var e = this.getBBox(),
                  ...
                  s =
                    Math.max(this.isTop ? i : 0, this.container.getWrapWidth(this.containerI)) -
                    o -
                    n,
              ...
              (e.prototype.setLineThickness = function (t, e, r) {
                return (
                  0.07 !== t &&
                    ...
                    'solid' !== e &&
                      (r['stroke-dasharray'] = ('dotted' === e ? '0,' : '') + this.fixed(2 * t))),
                  r
                )
              }),
              ...
              (e.prototype.topTable = function (t, e, r) {
                var o = this.adaptor,
                  ...
                  v = 'scale('.concat(
                    this.jax.fixed((1e3 * this.font.params.x_height) / this.metrics.ex, 2),
                    ')',
                  ),
                  ...
                  b = this.svg(
                    'svg',
                    {
                      'data-table': !0,
                      preserveAspectRatio:
                        'left' === f ? 'xMinYMid' : 'right' === f ? 'xMaxYMid' : 'xMidYMid',
              ...
              (e.prototype.subTable = function (t, e, r, o) {
                ...
                this.place(
                  'left' === r
                    ? ('left' === u ? 0 : 'right' === u ? c - p + o : (c - p) / 2 + o) - s
            ...
            return (
              ...
              (e.prototype.placeCell = function (t, e) {
                var r = e.x,
                  ...
                  x = n + a + s
                return (
                  t.placeColor(-(g + n + l / 2), -(d + m + b), x + (l + c) / 2, p + d + y + m),
                  x + c
                )
              }),
